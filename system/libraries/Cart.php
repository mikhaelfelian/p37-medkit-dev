...
class CI_Cart {
	...
	var $product_id_rules	= '\. a-z0-9A-Z_-'; // alpha-numeric, dashes, underscores, or periods
	var $product_name_rules	= '\.\:\-\/-_ \'\\/a-z0-9A-Z\+\(\),"'; // alpha-numeric, dashes, underscores, colons or periods
