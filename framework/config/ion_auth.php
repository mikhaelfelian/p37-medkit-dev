...
$config['user_expire']                = 25200;               // (7 Hours) How long to remember the user (seconds). Set to zero for no expiration
...
$config['lockout_time']               = 25200;               // (7 Hours) The number of seconds to lockout an account due to exceeded attempts
...
$config['identity_cookie_name'] = 'GeTMedkit_IdCode';
...
$config['message_start_delimiter'] = '<div class="alert alert-warning">'; 	// Message start delimiter
