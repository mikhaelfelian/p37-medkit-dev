                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            <select id="tipe" name="tipe" class="form-control select2bs4 <?php echo (!empty($hasError['dokter']) ? ' is-invalid' : '') ?>">
...
//                                                $tot_remun   = $tot_remun + $cuti->remun_subtotal;
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-left" style="width: 200px;">
                                                        <?php echo anchor(base_url('sdm/data_cuti_det.php?id=' . general::enkrip($cuti->id).'&route=sdm/data_cuti_list.php?tipe=1'), '#' . $cuti->no_surat, 'class="text-default" target="_blank"') ?>
                                                        <?php echo br(); ?>
                                                        <span class="mailbox-read-time float-left"><?php echo $this->tanggalan->tgl_indo5($cuti->tgl_simpan); ?></span>
                                                    </td>
