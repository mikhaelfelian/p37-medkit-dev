...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-8">
                    <?php echo form_open(base_url('laporan/set_data_stok_masuk.php'), 'autocomplete="off"') ?> 
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">Form Laporan Stok Masuk</h3>
            ...
            <?php if ($_GET['jml'] > 0) { ?><div class="row">
                    <div class="col-md-12">
                        <div class="card card-default">
                            <div class="card-header">
                                <h3 class="card-title">Data Laporan Stok Masuk</h3>
                                <div class="card-tools">
                                    ...
                                    <tbody>
                                        ...
                                        if (!empty($sql_penj)) {
                                            ...
                                            foreach ($sql_penj as $penj) {
                                                $sql_beli_det = $this->db->where('id', $penj->id_beli_det)->get('tbl_trans_beli_det')->row();
                                                ?>
                                                <tr>
                                                    ...
                                                    <td class="text-left" style="width: 150px;">
                                                        <?php echo anchor(base_url('medcheck/detail.php?id=' . general::enkrip($penj->id).'&route=laporan/data_stok_keluar.php'), '#' . $penj->no_nota, 'class="text-default" target="_blank"') ?>
                                                        <?php echo br(); ?>
                                                    ...
                                                    <td class="text-left" style="width: 450px;">
                                                        <?php if(!empty($sql_beli_det->kode_batch)){ ?>
                                                            <small><i><?php echo $sql_beli_det->kode_batch.(!empty($sql_beli_det->tgl_ed) ? ' / '.$sql_beli_det->tgl_ed : '' ).br(); ?></i></small>
                                                        <?php } ?>
                                                        <b><?php echo $penj->item; ?></b>
                                                        <?php echo br(); ?>
                                                        <small><?php echo $penj->supplier; ?></small>
                                                    </td>
