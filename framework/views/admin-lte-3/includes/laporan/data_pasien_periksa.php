...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-8">
                    <?php echo form_open(base_url('laporan/set_data_pemeriksaan.php'), 'autocomplete="off"') ?> 
                                        ...
                                        if (!empty($sql_pasien)) {
                                            ...
                                            foreach ($sql_pasien as $pasien) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-left">
                                                        <?php echo anchor($uri_det.'&id='.general::enkrip($pasien->id_medcheck).'&pasien='.$pasien->nama.'&route=laporan/'.$uri.'.php', 'Detail &raquo;', 'class="btn btn-primary btn-flat btn-xs text-bold" style="width: 55px;"') ?>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        <?php } ?>
