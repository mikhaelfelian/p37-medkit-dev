                    ...
                    <div class="col-md-12">
                        <div class="card card-default">
                            ...
                            <div class="card-body">
                                ...
                                <?php $tot_diskon = $sql_omset_row->jml_total - $sql_omset_row->jml_gtotal ?>
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-right text-bold"><?php echo general::format_angka($sql_omset_row->jml_total) ?></td>
                                        ...
                                        if (!empty($sql_omset)) {
                                            ...
                                            foreach ($sql_omset as $omset) {
                                                ...
                                                $jml_tot_disk   = $jml_tot_disk + $omset->jml_diskon;
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right" style="width: 100px;">
                                                        <?php echo general::format_angka($omset->jml_diskon); ?>
                                                    </td>
                                                    <td class="text-right" style="width: 100px;">
