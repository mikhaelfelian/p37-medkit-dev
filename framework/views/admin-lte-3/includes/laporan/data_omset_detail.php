...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-8">
                    <?php echo form_open(base_url('laporan/set_data_omset_detail.php'), 'autocomplete="off"') ?> 
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">Form Laporan Omset Detail</h3>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <?php echo form_input(array('id' => 'tgl', 'name' => 'tgl', 'class' => 'form-control rounded-0 text-middle' . (!empty($hasError['pasien']) ? ' is-invalid' : ''), 'style' => 'vertical-align: middle;', 'placeholder' => '02/15/2022 ...', 'value' => (isset($_GET['tgl']) ? $this->tanggalan->tgl_indo($_GET['tgl']) : ''))) ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <?php echo form_input(array('id' => 'tgl_rentang', 'name' => 'tgl_rentang', 'class' => 'form-control rounded-0 text-middle' . (!empty($hasError['pasien']) ? ' is-invalid' : ''), 'style' => 'vertical-align: middle;', 'placeholder' => '02/15/2022 - 02/15/2022 ...', 'value' => (isset($_GET['tgl_awal']) ? $this->tanggalan->tgl_indo2($_GET['tgl_awal']) : ''))) ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group <?php echo (!empty($hasError['poli']) ? 'text-danger' : '') ?>">
                                        ...
                                        <select name="poli" class="form-control rounded-0 select2bs4 <?php echo (!empty($hasError['poli']) ? ' is-invalid' : '') ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control rounded-0">
                                            <option value="">[Jenis Item]</option>
                                                ...
                                                <option value="4" <?php echo ($_GET['status'] == '4' ? 'selected' : '') ?>>Obat</option>
                                            ...
                                            foreach ($sql_penj as $penj) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-left" style="width: 150px;">
                                                        <?php echo anchor(base_url('medcheck/detail.php?id=' . general::enkrip($penj->id_medcheck).'&route=laporan/data_omset_detail.php'), '#' . $penj->no_rm, 'class="text-default" target="_blank"') ?>
                                                        <?php echo br(); ?>
                                                    ...
                                                    <td class="text-left" style="width: 450px;">
                                                        ...
                                                        <?php echo br(); ?>
                                                        <small><i><?php echo (!empty($penj->poli) ? $penj->poli.' / '.general::status_rawat2($penj->tipe) : ''); ?></i></small>
                                                    </td>
