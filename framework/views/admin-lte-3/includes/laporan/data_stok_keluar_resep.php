...
<div class="content-wrapper">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Data Penggunaan Resep</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-8">
                    <?php echo form_open(base_url('laporan/set_data_stok_keluar_resep.php'), 'autocomplete="off"') ?> 
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">Form Laporan Penggunaan Resep per Dokter</h3>
            ...
            <?php if ($_GET['jml'] > 0) { ?>
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-default">
                            <div class="card-header">
                                <h3 class="card-title">Data Laporan Penggunaan Resep per Dokter</h3>
                                <div class="card-tools">
                            ...
                            <div class="card-body">
                                ...
                                switch ($case) {
                                    case 'per_tanggal':
                                        ...
                                        $uri_xls = base_url('laporan/xls_' . $uri . '.php?case=' . $case.'&dokter='.$dokter . '&tgl=' . $tg . (!empty($sales) ? "&id_sales=" . $sales . "" : "").(!empty($poli) ? "&poli=" . $poli . "" : ""));
                                        break;
                                    ...
                                    case 'per_rentang':
                                        ...
                                        $uri_xls = base_url('laporan/xls_' . $uri . '.php?case=' . $case.'&dokter='.$dokter. '&tgl_awal=' . $tg_awal . '&tgl_akhir=' . $tg_akhr);
                                        break;
                                }
                                ?>
