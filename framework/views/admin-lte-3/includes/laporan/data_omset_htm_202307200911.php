    ...
    <tbody>
        ...
        if (!empty($sql_omset)) {
            ...
            foreach ($sql_omset as $penjualan) {
                ...
                $regonya    = ($sql_pnjm->persen != 0 ? $ass : $harga); # Jika penjamin asuransi, maka harga obat di tambah sesuai setelan % pada database
                ...
                $harga_disk = (($regonya - $disk3) * $penjualan->jml);
