            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Surat Keterangan Detail</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php if (!empty($sql_kary)) { ?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <?php echo form_input(array('id' => '', 'name' => 'tgl_surat', 'class' => 'form-control pull-right rounded-0' . (!empty($hasError['kode']) ? ' is-invalid' : ''), 'placeholder' => 'Isikan tanggal mulai kerja...', 'readonly' => 'TRUE', 'value' => $this->tanggalan->tgl_indo2($sql_krj->tgl_masuk))) ?>
                                            </div>
                                        </div>
                                    <?php } ?>
                                </div>
                                <div class="col-md-6">
                                    <?php if (!empty($sql_kary)) { ?>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <?php echo form_textarea(array('id' => 'keterangan', 'name' => 'ket', 'class' => 'form-control pull-right rounded-0' . (!empty($hasError['kode']) ? ' is-invalid' : ''), 'placeholder' => 'Isikan keterangan penggunaan surat ini...', 'readonly' => 'TRUE', 'value' => $sql_krj->keterangan)) ?>
                                            </div>
                                        </div>
                                    <?php } ?>
                                </div>
