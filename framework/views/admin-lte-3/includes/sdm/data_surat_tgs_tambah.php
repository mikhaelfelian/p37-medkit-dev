...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <?php echo form_open(base_url('sdm/set_surat_tgs_simpan.php'), 'autocomplete="off"') ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php if (!empty($sql_kary)) { ?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <?php echo form_input(array('id' => 'tgl_keluar', 'name' => 'tgl_keluar', 'class' => 'form-control pull-right rounded-0' . (!empty($hasError['kode']) ? ' is-invalid' : ''), 'placeholder' => 'Isikan tanggal selesai ...')) ?>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputEmail3" class="col-sm-4 col-form-label">Penugasan</label>
                                            <div class="col-sm-8">
                                                <?php echo form_input(array('id' => 'judul', 'name' => 'judul', 'class' => 'form-control pull-right rounded-0' . (!empty($hasError['kode']) ? ' is-invalid' : ''), 'placeholder' => 'Isikan kegiatan ...')) ?>
                                            </div>
                                        </div>
                                    <?php } ?>
                                </div>
                                <div class="col-md-6">
                                    <?php if (!empty($sql_kary)) { ?>
                                        <div class="form-group">
                                            ...
                                            <?php echo form_textarea(array('id' => 'keterangan', 'name' => 'ket', 'class' => 'form-control pull-right rounded-0' . (!empty($hasError['kode']) ? ' is-invalid' : ''), 'placeholder' => 'Isikan keterangan atau detail penugasan ...')) ?>
                                        </div>
                                    <?php } ?>
                                </div>
                            </div>
    ...
    $(function () {
        ...
        $('#karyawan').autocomplete({
            ...
            select: function (event, ui) {
                ...
                window.location.href = "<?php echo base_url('sdm/data_surat_tgs_tambah.php?') ?>id=" + ui.item.id;
