                        ...
                        <div class="card-body table-responsive">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <?php echo form_open(base_url('transaksi/beli/set_trans_beli_po.php'), 'autocomplete="off"') ?>
                                ...
                                <div class="col-md-6">
                                    <?php if (!empty($sess_beli)) { ?>
                                        <?php echo form_open(base_url('transaksi/beli/cart_beli_po_simpan.php'), 'autocomplete="off"') ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-right">
                                        <?php if (!empty($sql_beli)) { ?>
                                            <?php echo form_open(base_url('transaksi/beli/set_trans_beli_po_proses.php'), 'autocomplete="off"') ?>
