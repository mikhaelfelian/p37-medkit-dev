...
<div class="row">
    <div class="col-md-10">
        ...
        <?php echo form_hidden('route', 'profile.php?page=profile_peg'); ?>
                        ...
                        <?php foreach ($sql_kary_peg as $peg) { ?>
                            ...
                            <tr>
                                ...
                                <td class="text-left" style="width:250px;">
                                    ...
                                    <small><b>Tgl Bergabung :</b> <i><?php echo ($peg->tgl_masuk != '0000' ? $this->tanggalan->tgl_indo2($peg->tgl_masuk) : ''); ?></i></small><br/>
                                    <small><b>Tgl Selesai :</b> <i><?php echo ($peg->tgl_keluar != '0000' ? $this->tanggalan->tgl_indo2($peg->tgl_keluar) : ''); ?></i></small><br/>
                                    <small><i><?php echo ($peg->tgl_masuk != '0000' ? $this->tanggalan->usia($peg->tgl_masuk) : ''); ?></i></small><br/>
                                </td>
                                ...
                                <td class="text-left" style="width:70px;">
                                    <?php echo anchor(base_url('master/set_karyawan_hapus_peg.php?id=' . general::enkrip($peg->id) . '&id_karyawan=' . general::enkrip($sql_kary->id).'&route=profile.php?page=profile_peg'), '<i class="fa fa-trash"></i>', 'class="btn btn-danger btn-flat btn-xs" onclick="return confirm(\'Hapus Berkas [' . $peg->kode . '] ?\')"') ?>
                                    <?php echo anchor(base_url('sdm/pdf_surat_pkl.php?id='.general::enkrip($peg->id)), '<i class="fa fa-print"></i>', 'class="btn btn-primary btn-flat btn-xs"') ?>
                                </td>
                            </tr>
                            <?php $no++ ?>
                        <?php } ?>
