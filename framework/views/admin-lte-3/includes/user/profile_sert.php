...
<div class="row">
    <div class="col-md-9">
        ...
        <?php echo form_hidden('route', 'profile.php?page=profile_sert'); ?>
...
<!--                                        <a href="<?php // echo $filename ?>" data-toggle="lightbox" data-title="<?php // echo strtolower($sert->judul . ' - ' . $sql_pasien->nama_pgl) ?>">
                                        ...
                                        <a href="<?php echo $filename ?>" data-toggle="lightbox" data-title="<?php echo strtolower($sert->judul . ' - ' . $sql_pasien->nama_pgl) ?>">
                                            <img src="<?php echo $filename ?>" alt="<?php echo strtolower($sert->judul . ' - ' . $sql_pasien->nama_pgl) ?>" style="width: 100px; height: 100px;">
                                        </a>
                                    <?php } else { ?>
                                ...
                                <td class="text-left" style="width:70px;">
                                    <?php echo anchor(base_url('master/set_karyawan_hapus_sert.php?id=' . general::enkrip($sert->id) . '&id_karyawan=' . general::enkrip($sql_kary->id) . (!empty($sert->file_name) ? '&file_name=' . $sert->file_name : '') . '&route=profile.php?page=profile_sert'), '<i class="fa fa-trash"></i>', 'class="btn btn-danger btn-flat btn-xs" onclick="return confirm(\'Hapus Berkas [' . $sert->no_dok . '] ?\')"') ?>
                                </td>
                            </tr>
                            <?php $no++ ?>
                        <?php } ?>
