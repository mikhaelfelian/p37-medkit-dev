...
<html lang="en">
    <head>
        ...
        <!-- icheck bootstrap -->
        <link rel="stylesheet" href="<?php echo base_url('assets/theme/admin-lte-3/plugins/icheck-bootstrap/icheck-bootstrap.min.css'); ?>">
        ...
        <div class="login-box">
            ...
            <div class="card card-outline card-success">
                <div class="card-header text-center">
                    <a href="#" class="h1"><img src="<?php echo base_url('assets/theme/admin-lte-3/dist/img/'.(!empty($pengaturan->logo) ? $pengaturan->logo : 'AdminLTELogo.png')); ?>" alt="<?php echo $pengaturan->judul.' Logo'; ?>" class="brand-image img-rounded" style="width: 209px; height: 94px; background-color: #fff;"></a>
                </div>
                <div class="card-body">
                    ...
                    <?php echo form_open(base_url('cek_login.php'), 'autocomplete="off"') ?>
                        <div class="input-group mb-3">
                            ...
                            <?php if(!empty($hasError['user'])){ ?>
                                <span id="exampleInputPassword1-error" class="error invalid-feedback"><?php echo $hasError['user']; ?></span>
                            <?php } ?>
                        </div>
                        <div class="input-group mb-3">
                            ...
                            <?php if(!empty($hasError['pass'])){ ?>
                                <span id="exampleInputPassword1-error" class="error invalid-feedback"><?php echo $hasError['pass']; ?></span>
                            <?php } ?>
                        </div>
                        <div class="input-group mb-3">
                            <?php echo $recaptcha; ?>
                        ...
                        <div class="row">
                            ...
                            <!-- /.col -->
                            <div class="col-4">
                                <button type="submit" name="login" value="login_aksi" class="btn btn-primary btn-block">Masuk</button>
                            </div>
                            <!-- /.col -->
                        </div>
                    <?php echo form_close() ?>
