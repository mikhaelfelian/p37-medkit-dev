            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Peneriman</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                        ...
                        <div class="card-body p-0">
                            ...
                            <table class="table table-stripped">
                                <thead>
                                    ...
                                    <?php echo form_open_multipart(base_url('gudang/set_cari_pemb.php'), 'autocomplete="off"') ?> 
                                    <tr>
                                        <td></td>
                                        <td>
                                    ...
                                    if (!empty($sql_beli)) {
                                        ...
                                        foreach ($sql_beli as $beli) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $this->tanggalan->tgl_indo($beli->tgl_masuk) ?></td>
                                                <td>
                                                    <?php if (akses::hakSA() == TRUE OR akses::hakOwner() == TRUE OR akses::hakAdminM() == TRUE OR akses::hakAdmin() == TRUE) { ?>
                                                        <?php if($beli->status_penerimaan == '0'){ ?>
                                                            <?php // echo anchor(base_url('gudang/trans_beli_edit.php?id='.general::enkrip($beli->id)), '<i class="fa fa-edit"></i> Ubah', 'class="btn btn-info btn-flat btn-xs" style="width: 55px;"') ?>
                                                            <?php echo anchor(base_url('gudang/trans_beli_terima.php?id='.general::enkrip($beli->id)), '<i class="fa fa-check"></i> Terima', 'class="btn btn-primary btn-flat btn-xs" style="width: 65px;"') ?><br/>
                                                        <?php } ?>
                                                        <?php // echo anchor(base_url('gudang/trans_beli_reset.php?id='.general::enkrip($beli->id)), '<i class="fa fa-undo"></i> Reset', 'class="btn btn-danger btn-flat btn-xs" style="width: 65px;" onclick="return confirm(\'Reset Penerimaan ?\')"').br() ?>
                                                    <?php } ?>
                                                    <?php echo general::status_penerimaan($beli->status_penerimaan) ?>
                                                </td>
                                            </tr>
                                            <?php
                                        }
