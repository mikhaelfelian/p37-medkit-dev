...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">FORM PEMERIKSAAN FISIK - <?php echo $sql_pasien->nama_pgl; ?> <small><i>(<?php echo $this->tanggalan->usia($sql_pasien->tgl_lahir) ?>)</i></small></h3>
    </div>
    <div class="card-body">
                ...
                <div class="tab-content" id="vert-tabs-tabContent">
                    <div class="tab-pane text-left fade show active" id="tab-pemeriksaan" role="tabpanel" aria-labelledby="vert-tabs-home-tab">
                        <?php if (akses::hakSA() == TRUE OR akses::hakOwner() == TRUE OR akses::hakOwner2() == TRUE OR akses::hakDokter() == TRUE OR akses::hakPerawat() == TRUE OR akses::hakAnalis() == TRUE) { ?>
                            ...
                            <a href="<?php echo base_url('medcheck/set_medcheck_ass_fisik.php?act='.$this->input->get('act').'&id=' . general::enkrip($sql_medc->id) . '&status=' . $this->input->get('status')) ?>" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> Assesment</a>
                            <?php // } ?>
                        <?php } ?>
                        <?php echo br(2) ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left" style="width: 90px;">
                                            <?php if (akses::hakSA() == TRUE OR akses::hakOwner() == TRUE OR akses::hakOwner2() == TRUE OR akses::hakFarmasi() == TRUE OR akses::hakDokter() == TRUE OR akses::hakPerawat() == TRUE OR akses::hakAnalis() == TRUE) { ?>
                                                ...
                                                <?php echo anchor(base_url('medcheck/surat/cetak_pdf_ass_fisik.php?id=' . general::enkrip($sql_medc->id) . '&id_ass=' . general::enkrip($asses->id) . '&status=15'), 'Cetak &raquo;', 'class="btn btn-success btn-flat btn-xs text-bold" style="width: 70px;"') ?>
                                                <?php echo br() ?>
                                            <?php } ?>
                                        </td>
                                    </tr>
