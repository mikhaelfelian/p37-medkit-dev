                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left" style="width: 90px;">
                                            <?php if (akses::hakSA() == TRUE OR akses::hakOwner() == TRUE OR akses::hakOwner2() == TRUE OR akses::hakAnalis() == TRUE OR akses::hakDokter() == TRUE OR akses::hakPerawat() == TRUE) { ?>
                                                ...
                                                <?php echo anchor(base_url('medcheck/surat/cetak_pdf_lab_ekg.php?id=' . $this->input->get('id') . '&status=' . $this->input->get('status') . '&id_lab=' . general::enkrip($lab->id)), '<i class="fas fa-print"></i> Cetak &raquo;', 'class="btn btn-primary btn-flat btn-xs" style="width: 70px;"') ?>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                    <?php $no++ ?>
