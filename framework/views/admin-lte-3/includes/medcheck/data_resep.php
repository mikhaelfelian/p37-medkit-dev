                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-striped project">
                                <thead>
                                    <?php echo form_open_multipart(base_url('medcheck/resep/set_cari_resep.php'), 'autocomplete="off"') ?> 
                                    <tr>
                                        <td colspan="2"></td>
                                        <td>
                                        ...
                                        foreach ($penj as $penj) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center" style="width: 150px;">
                                                    <a class="btn btn-primary btn-sm" href="<?php echo base_url('medcheck/tambah.php?act=res_input&id=' . general::enkrip($penj->id) . '&id_resep=' . general::enkrip($penj->id_resep) . '&status=4') ?>">
