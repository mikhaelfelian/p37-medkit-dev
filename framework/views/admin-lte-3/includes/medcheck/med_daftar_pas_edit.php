    ...
    <section id="pasien_baru1">
        ...
        <div class="form-group">
            ...
            <div class="input-group mb-3">
                ...
                <?php echo form_input(array('id' => 'tgl_lahir', 'name' => 'tgl_lahir', 'class' => 'form-control', 'value' => (!empty($sql_dft_id->tgl_lahir) ? $this->tanggalan->tgl_indo8($sql_dft_id->tgl_lahir) : $this->session->flashdata('tgl_lahir')), 'placeholder' => 'Isi dengan format berikut : 02/15/1992 ...', 'readonly' => 'TRUE')) ?>
            </div>                                        
        </div>
