                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left" style="width: 90px;">
                                            <?php if (akses::hakSA() == TRUE OR akses::hakOwner() == TRUE OR akses::hakOwner2() == TRUE OR akses::hakAnalis() == TRUE OR akses::hakDokter() == TRUE OR akses::hakPerawat() == TRUE) { ?>
                                                <?php echo anchor(base_url('medcheck/tambah.php?act=lab_ekg_input&id=' . general::enkrip($sql_medc->id) . '&id_lab=' . general::enkrip($lab->id) . '&status=' . $this->input->get('status')), 'Input &raquo;', 'class="btn btn-success btn-flat btn-xs text-bold" style="width: 70px;"') ?>
                                                <?php echo anchor(base_url('medcheck/surat/cetak_pdf_lab_ekg.php?id=' . $this->input->get('id') . '&status=' . $this->input->get('status') . '&id_lab=' . general::enkrip($lab->id)), 'Cetak &raquo;', 'class="btn btn-primary btn-flat btn-xs text-bold" style="width: 70px;"') ?>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                    <?php $no++ ?>
