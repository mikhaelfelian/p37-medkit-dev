            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Anamnesa</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group <?php echo (!empty($hasError['dokter']) ? 'text-danger' : '') ?>">
                                        <label class="control-label">Dokter Utamas</label>
                                    ...
                                    <div class="form-group <?php // echo (!empty($hasError['pasien']) ? 'has-error' : '')        ?>">
                                        ...
                                        <div class="input-group mb-3">
                                            <?php echo form_input(array('id' => 'petugas', 'name' => 'petugas', 'class' => 'form-control pull-right', 'placeholder' => 'Nama Petugas ...', 'value' => $this->ion_auth->user()->row()->first_name, 'disabled' => 'true')) ?>
                                        </div>
                                    </div>
                                    <div class="form-group <?php // echo (!empty($hasError['keluhan']) ? 'has-error' : '')        ?>">
                                        <label class="control-label">Keluhan</label>
                                        <div class="input-group mb-3">
                                            <?php echo form_textarea(array('id' => 'anamnesa', 'name' => 'anamnesa', 'class' => 'form-control pull-right', 'value' => $sql_medc->keluhan, 'style' => 'height: 211px;', 'disabled' => 'true')) ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group <?php // echo (!empty($hasError['anamnesa']) ? 'text-danger' : '') ?>">
                                        <label class="control-label">Anamnesa</label>
                                        <div class="input-group mb-3">
                                            <?php echo form_textarea(array('id' => 'anamnesa', 'name' => 'anamnesa', 'class' => 'form-control pull-right' . (!empty($hasError['anamnesa']) ? ' is-invalid' : ''), 'value' => $sql_medc->anamnesa, 'placeholder' => 'Tindakan Anamnesa ...', 'style' => 'height: 123px;')) ?>
                                        </div>
                                    </div>
                                    <div class="form-group <?php // echo (!empty($hasError['keluhan']) ? 'has-error' : '')        ?>">
                                        <label class="control-label">Pemeriksaan</label>
                                        <div class="input-group mb-3">
                                            <?php echo form_textarea(array('id' => 'pemeriksaan', 'name' => 'pemeriksaan', 'class' => 'form-control pull-right', 'value' => $sql_medc->pemeriksaan, 'placeholder' => 'Tindakan Diagnosa ...', 'style' => 'height: 123px;')) ?>
                                        </div>
                                    </div>
                                    <div class="form-group <?php // echo (!empty($hasError['keluhan']) ? 'has-error' : '')        ?>">
                                        <label class="control-label">Diagnosa</label>
                                        <div class="input-group mb-3">
                                            <?php echo form_textarea(array('id' => 'diagnosa', 'name' => 'diagnosa', 'class' => 'form-control pull-right', 'value' => $sql_medc->diagnosa, 'placeholder' => 'Tindakan Diagnosa ...', 'style' => 'height: 123px;')) ?>
                                        </div>
                                    </div>
                                    <div class="form-group has-error <?php echo (!empty($hasError['status_periksa']) ? 'has-error' : '') ?>">
                                        <div class="input-group mb-3">
                                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                                <?php $sudah = ($sql_medc->status_periksa == '1' ? 'TRUE' : ''); ?>
                                                <?php echo form_checkbox(array('id'=>'customSwitch3', 'name'=>'status_periksa', 'class'=>'custom-control-input', 'value'=>'1', 'checked'=>$sudah)) ?>
                                                <label class="custom-control-label" for="customSwitch3">Sudah dilakukan pemeriksaan</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
