<?php echo form_open_multipart(base_url('medcheck/'.(isset($_GET['id_item']) ? 'set_medcheck_resm_hsl_upd' : 'set_medcheck_resm_hsl').'.php'), 'autocomplete="off"') ?>
        ...
        <div class="row">
            <div class="col-md-8">                    
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <?php echo form_input(array('id' => 'pemeriksaan', 'name' => 'pemeriksaan', 'class' => 'form-control pull-right rounded-0' . (!empty($hasError['pemeriksaan']) ? ' is-invalid' : ''), 'placeholder' => 'Isikan Pemeriksaan ...', 'value' => $sql_medc_resm_hs->param)) ?>
                    </div>
                </div>
                <div class="form-group row">
