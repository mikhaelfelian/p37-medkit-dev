                ...
                <div class="col-md-12">
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">Data Penunjang Spirometri</h3>
                                        ...
                                        foreach ($penj as $penj) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center" style="width: 150px;">
                                                    <a class="btn btn-primary btn-sm" href="<?php echo base_url('medcheck/tambah.php?act=pen_spirometri&id=' . general::enkrip($penj->id_medcheck) . '&status=17') ?>">
