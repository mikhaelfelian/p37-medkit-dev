                                        ...
                                        foreach ($penj as $penj) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-left" style="width: 170px;">
                                                    ...
                                                    <?php echo br(); ?>
                                                    <small><i><?php echo $penj->no_rad ?></i></small>
                                                    <?php echo br(); ?>
                                                ...
                                                <td style="width: 450px;">
                                                    ...
                                                    <?php echo br(); ?>
                                                    <small><i><?php echo $this->ion_auth->user($penj->id_radiografer)->row()->first_name; ?></i></small>
                                                </td>
                                                ...
                                                <td class="text-center" style="width: 150px;">
                                                    <?php echo anchor(base_url('medcheck/tambah.php?act=rad_surat&id='.general::enkrip($penj->id).'&id_rad='.general::enkrip($penj->id_rad).'&status=5&route=medcheck/data_radiologi.php?status='.$this->input->get('status')), 'Sample &raquo;', 'class="btn btn-success btn-flat btn-xs text-bold" style="width: 70px;"') ?>
                                                    <?php echo anchor(base_url('medcheck/tambah.php?act=rad_input&id='.general::enkrip($penj->id).'&id_rad='.general::enkrip($penj->id_rad).'&status=5&route=medcheck/data_radiologi.php?status='.$this->input->get('status')), 'Input &raquo;', 'class="btn btn-warning btn-flat btn-xs text-bold" style="width: 70px;"') ?>
                                                    <?php echo br(); ?>
                                                    <?php echo general::status_rad($penj->status); ?>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    <?php } ?>
