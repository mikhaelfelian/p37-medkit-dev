            ...
            <?php if ($_GET['act'] == 'ubah_data') { ?>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <?php echo form_input(array('id' => 'tgl_lahir', 'name' => 'tgl_lahir', 'class' => 'form-control', 'value' => (!empty($pasien->tgl_lahir) ? $this->tanggalan->tgl_indo($pasien->tgl_lahir) : $this->session->flashdata('tgl_lahir')), 'placeholder' => 'Isi dengan format berikut : 02/15/1992 ...', 'readonly' => 'TRUE')) ?>
                    </div>                                        
                </div>

                <div class="form-group <?php echo (!empty($hasError['nama']) ? 'has-error' : '') ?>">
                    <label class="control-label">No. HP <i><small class="text-danger">* Inputkan Angka saja (cth: 085741220455)</small></i></label>
    ...
    <?php if (!empty($pasien)) { ?>
        ...
        <?php } else { ?>
            <section id="pasien_baru2">
                <div class="form-group <?php echo (!empty($hasError['nik']) ? 'has-error' : '') ?>">
                    <label class="control-label">Alamat KTP<small><i>* Sesuai Identitas</i></small></label>
                    <?php echo form_textarea(array('id' => 'alamat', 'name' => 'alamat', 'class' => 'form-control', 'value' => (!empty($pasien->alamat) ? $pasien->alamat : $this->session->flashdata('alamat')), 'style' => 'height: 124px;', 'placeholder' => 'Mohon diisi alamat lengkap ...', 'readonly' => 'TRUE')) ?>
                </div>
                <div class="form-group <?php echo (!empty($hasError['nik']) ? 'has-error' : '') ?>">
                    <label class="control-label">Alamat Domisili<small><i>* Sesuai Domisili</i></small></label>
                    <?php echo form_textarea(array('id' => 'alamat', 'name' => 'alamat_dom', 'class' => 'form-control', 'value' => (!empty($pasien->alamat_dom) ? $pasien->alamat_dom : $this->session->flashdata('alamat_dom')), 'style' => 'height: 124px;', 'placeholder' => 'Mohon diisi alamat lengkap ...', 'readonly' => 'TRUE')) ?>
                </div>
                <div class="form-group">
...
<?php } else { ?>
    ...
    <div class="col-md-6">
        <section id="pasien_baru2">
            <div class="form-group">
                <label class="control-label">&nbsp;</label><br/>
                <a href="<?php echo base_url('master/data_mcu_perusahaan_tambah.php?tipe_pas=' . $this->input->get('tipe_pas') . '&id_pasien=' . $this->input->get('id_pasien') . '&route=medcheck/daftar.php') ?>" class="btn btn-primary btn-flat">
                    <i class="fa fa-plus-circle"></i> Tambah
                </a>
                <!--<label class="control-label">Alamat Instansi</label>-->                
                <?php // echo form_input(array('id' => 'instansi_almt', 'name' => 'instansi_almt', 'class' => 'form-control', 'value' => (!empty($pasien->instansi_alamat) ? $pasien->instansi_alamat : $this->session->flashdata('instansi_alamat')), 'placeholder' => 'Isikan alamat lengkapnya ...')) ?>
