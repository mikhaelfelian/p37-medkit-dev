                ...
                <div class="col-md-12">
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">Data Penunjang HRV</h3>
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-striped project">
                                <thead>
                                    <?php echo form_open(base_url('medcheck/ekg/set_cari_hrv.php'), 'autocomplete="off"') ?> 
                                    <tr>
                                        <td colspan="2"></td>
                                        <td>
                                        ...
                                        foreach ($penj as $penj) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center" style="width: 150px;">
                                                    <a class="btn btn-primary btn-sm" href="<?php echo base_url('medcheck/tambah.php?act=pen_hrv&id=' . general::enkrip($penj->id_medcheck) . '&status=17') ?>">
