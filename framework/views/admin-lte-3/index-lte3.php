        ...
        <div class="wrapper">
            ...
            <nav class="main-header navbar navbar-expand navbar-white navbar-light">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-none d-sm-inline-block">
                        <a href="<?php echo base_url('dashboard.php') ?>" class="nav-link">Master</a>
                    </li>
                    <li class="nav-item d-none d-sm-inline-block">
                        <a href="#" class="nav-link">Gudang</a>
                    </li>
                    <li class="nav-item d-none d-sm-inline-block">
                        <a href="<?php echo base_url('dashboard.php') ?>" class="nav-link">Medical Check</a>
                    </li>
                    <li class="nav-item d-none d-sm-inline-block">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <a href="index3.html" class="brand-link">
                    <?php $pengaturan = $this->db->get('tbl_pengaturan')->row(); ?>
                    <img src="<?php echo base_url('assets/theme/admin-lte-3/');  ?>dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                    <span class="brand-text font-weight-light"><?php echo $pengaturan->judul; ?></span>
                </a>
                ...
                <div class="sidebar">
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        ...
                        <div class="image">
                            <!--<img src="<?php echo base_url('assets/theme/admin-lte-3/');  ?>dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">-->
                                    ...
                                    <div class="card-body table-responsive p-0">
                                        <table class="table table-striped table-valign-middle">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="<?php echo base_url('assets/theme/admin-lte-3/');  ?>dist/img/default-150x150.png" alt="Product 1" class="img-circle img-size-32 mr-2">
                                                        Some Product
                                                    </td>
                                                    <td>$13 USD</td>
                                                    <td>
