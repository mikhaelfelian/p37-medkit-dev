                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><hr/></li>
                                <li><a href="<?php echo base_url('transaksi/trans_jual_pen.php') ?>">Buat Penawaran</a></li>
                                <li><a href="<?php echo base_url('transaksi/data_pen_list.php') ?>">Data Penawaran</a></li>
                                <li><hr/></li>
