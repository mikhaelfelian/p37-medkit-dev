            ...
            <div class="col-lg-12">
                <div class="box box-warning">
                    ...
                    <div class="box-body">
                        ...
                        switch ($case) {
                            case 'per_tanggal':
                                $parameter = '&tipe='.$tipe.'&query='.$kueri.'&merk='.$merk.'&sales='.$sales;
                            break;

                            case 'per_rentang':
                                $parameter = '&tipe='.$tipe.'&tgl_awal='.$tgl_awal.'&tgl_akhir='.$tgl_akhr.'&merk='.$merk.'&sales='.$sales;                                 
                            break;
                        ...
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item" src="<?php echo base_url('laporan/pdf_'.$uri.'.php?'.(!empty($case) ? 'case='.$case : 'query='.$query).$parameter) ?>">
                            </iframe>
                        </div>
                    </div>
