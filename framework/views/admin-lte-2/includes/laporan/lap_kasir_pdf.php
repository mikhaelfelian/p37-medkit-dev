            ...
            <div class="col-lg-12">
                <div class="box box-warning">
                    ...
                    <div class="box-body">
                        ...
                        $parameter = '?tgl_awal='.$tgl_awal.'&tgl_akhir='.$tgl_akhir.(!empty($met_bayar) ? '&metode='.$met_bayar : '');
                        
                        ?>
                        <?php echo anchor(base_url('laporan/pdf_data_penjualan_kasir.php'.$parameter).'&type=D', '<i class="fa fa-download"></i> Unduh', 'target=""') ?>
                        <?php echo nbs(2) ?>
                        <?php echo anchor(base_url('laporan/pdf_data_penjualan_kasir.php'.$parameter), '<i class="fa fa-external-link-square"></i> Fullscreen', 'target="_blank"') ?>
                        <?php echo br(2) ?>
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item" src="<?php echo base_url('laporan/pdf_data_penjualan_kasir.php'.$parameter) ?>">
                            </iframe>
                        </div>
                    </div>
