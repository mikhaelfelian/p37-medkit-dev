<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-lg-6">
                <?php echo form_open(base_url('laporan/set_lap_pemasukan.php'), 'autocomplete="off"') ?>
                ...
                <div class="col-lg-12">
                    <div class="box box-warning">
                        ...
                        <div class="box-body table-responsive">
                            <!--<button class="btn btn-success btn-flat" onclick="window.location.href = '<?php echo base_url('laporan/data_pemasukan_pdf.php?route=' . $this->input->get('act') . '&case=' . $this->input->get('case') . '&query=' . $this->input->get('query') . '&tgl_awal=' . $this->input->get('tgl_awal') . '&tgl_akhir=' . $this->input->get('tgl_akhir') . '&status=' . $this->input->get('status')) ?>'"><i class="fa fa-file-pdf-o"></i> Cetak</button>-->
                            <button class="btn btn-success btn-flat" onclick="window.location.href = '<?php echo base_url('laporan/xls_data_pemasukan.php?route=' . $this->input->get('act') . '&case=' . $this->input->get('case') . '&query=' . $this->input->get('query') . '&tgl_awal=' . $this->input->get('tgl_awal') . '&tgl_akhir=' . $this->input->get('tgl_akhir') . '&status=' . $this->input->get('status')) ?>'"><i class="fa fa-file-excel-o"></i> Cetak</button>
                            <?php echo br(2) ?>
