<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Laporan <small>Data Pembelian</small></h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-lg-6">
                <?php echo form_open(base_url('laporan/set_lap_pembelian.php'), 'autocomplete="off"') ?>
...
<!--                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">                                
                                ...
                                <div class="form-group">
                                    <label class="control-label">Status PKP</label>
                ...
                <div class="col-lg-12">
                    <div class="box box-warning">
                        ...
                        <div class="box-body table-responsive">
                            ...
                            $ppn       = $this->input->get('status_ppn');
                            ?>
                            <button class="btn btn-success btn-flat" onclick="window.location.href = '<?php echo base_url('laporan/'.$uri.'_pdf.php?case='.$case.'&query='.$query.'&tgl_awal='.$tgl_awal.'&tgl_akhir='.$tgl_akhir.($ppn != 'x' ? '&status_ppn='.$ppn : '')) ?>'"><i class="fa fa-file-pdf-o"></i> Cetak</button>
                            <button class="btn btn-success btn-flat" onclick="window.location.href = '<?php echo base_url('laporan/xls_'.$uri.'.php?case='.$case.'&query='.$query.'&tgl_awal='.$tgl_awal.'&tgl_akhir='.$tgl_akhir.($ppn != 'x' ? '&status_ppn='.$ppn : '')) ?>'"><i class="fa fa-file-excel-o"></i> Cetak Excel</button>
                            <?php echo br() ?>
                                    ...
                                    <?php if (!empty($pembelian)) { ?>
                                        ...
                                        <?php foreach ($pembelian as $pembelian) { ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo general::status_bayar($pembelian->status_bayar) ?></td>
                                        ...
                                        <?php } ?>
                                        <tr>
                                            <td colspan="7" class="text-right"><label>Total Pembelian</label></td>
