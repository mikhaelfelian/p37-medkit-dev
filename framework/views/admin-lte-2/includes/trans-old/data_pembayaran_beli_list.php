                ...
                <div class="box box-warning">
                    ...
                    <div class="box-body table-responsive no-padding">
                        ...
                        <table class="table table-responsive">
                            ...
                            <?php echo form_open(base_url('transaksi/set_cari_pemb_bayar.php')) ?>
                                ...
                                if (!empty($penj)) {
                                    ...
                                    foreach ($penj as $penj) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo anchor(base_url('transaksi/trans_beli_det.php?id='.general::enkrip($penj->id).'&route='.$this->uri->segment(2)), $penj->no_nota, 'class="text-default"') ?></td>
                                            ...
                                            <td>
                                                ...
                                                <?php }else{ ?>
                                                    <?php echo anchor(base_url('transaksi/trans_bayar_beli.php?id='.general::enkrip($penj->id)), '<label class="label '.($penj->status_bayar == '2' ? 'label-primary' : 'label-warning').'" style="cursor: pointer;">'.($penj->status_bayar == '2' ? 'Kurang Bayar' : 'Bayar').' &raquo;</label>', 'class="text-default"') ?>
                                                <?php } ?>
                                            </td>
                                            <td>
