                                ...
                                <div class="col-md-6">                                    
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <th style="vertical-align: middle;">:</th>
                                            <td style="vertical-align: middle;">
                                                <?php echo form_checkbox(array('id' => 'status_ppn', 'name' => 'status_ppn', 'value' => '1', 'class' => 'pull-left', 'checked'=>($sql_beli->status_ppn == 1 ? 'TRUE' : ''))).nbs(3) ?> Ada PPN
                                            </td>
                                        </tr>
                                        <!--
                                        <tr>
                                        ...
                                        <tr>
                                            <td style="vertical-align: middle; text-align: right;" colspan="3">                                                
                                                <button type="button" class="btn btn-warning btn-flat" onclick="window.location.href='<?php echo base_url('transaksi/set_nota_batal.php?term=beli&route=data_pembelian_list.php') ?>'">Batal</button>
                    ...
                    <div class="col-lg-12">
                        <div class="box box-warning" id="data_pelanggan">
                            ...
                            <div class="box-footer">
                                <button type="button" class="btn btn-danger btn-flat pull-left" onclick="window.location.href='<?php echo base_url('transaksi/set_nota_batal.php?term=beli&route=data_pembelian_list.php') ?>'"><i class="fa fa-remove"></i> Batal</button>
                                <?php if (!empty($sql_beli_det)) { ?>
