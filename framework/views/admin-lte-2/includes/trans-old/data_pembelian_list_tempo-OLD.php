                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(akses::hakSA() == TRUE OR akses::hakOwner() == TRUE OR akses::hakAdmin() == TRUE){ ?>
                                                    ...
                                                    <?php echo nbs() ?>
                                                <?php } ?>
                                                <?php echo anchor(base_url('transaksi/cetak_nota_beli.php?id=' . general::enkrip($penj->id)), '<i class="fa fa-print"></i> '.($penj->cetak == '1' ? 'Cetak Ulang' : 'Cetak'), 'class="label '.($penj->cetak == '1' ? 'label-danger' : 'label-warning').'"') ?>
