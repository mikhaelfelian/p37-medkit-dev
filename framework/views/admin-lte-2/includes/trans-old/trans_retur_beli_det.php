                ...
                <div class="col-lg-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-shopping-cart"></i> Data Retur Pembelian</h3>
                        </div>
                        <div class="box-body">
                            ...
                            <table class="table table-striped">
                                <tr>
                                    <th>No. Retur</th>
                                    <th>:</th>
                                    <td><?php echo '#'.sprintf("%05s",$sql_ret->id) ?></td>
                            ...
                            <table class="table table-striped">
                                ...
                                <?php foreach ($sql_ret_det as $items) { ?>
                                    ...
                                    $sql_prod = $this->db->where('kode', $items->kode)->get('tbl_m_produk')->row();
                                    ?>
                                    <tr>
                                        ...
                                        <td class="text-left" style="width: 100px;"><?php echo anchor(base_url('gudang/data_stok_tambah.php?id='.general::enkrip($sql_prod->id)), $items->kode, 'target="_blank"') ?></td>
                                        <td class="text-left">                                            
                                ...
                                <tr>
                                    ...
                                    <th class="text-right" style="vertical-align: middle;">Jml Retur</th>
                                    <th  class="text-right" style="width: 200px;">
                                        <div class="input-group date">
                                            <div class="input-group-addon">
                                                Rp.
                                            </div>
                                            <?php echo form_input(array('name' => 'jml_gtotal', 'class' => 'form-control pull-right text-right', 'readonly' => 'TRUE', 'value' => general::format_angka($sql_ret->jml_retur))) ?>
                                        </div>
                                    </th>
                                </tr>
                            </table>
                        ...
                        <div class="box-footer">
                            <div class="row">
                                <div class="col-lg-6">
                                    <button type="button" onclick="window.location.href = '<?php echo base_url('transaksi/'.(isset($_GET['route']) ? $this->input->get('route') : 'data_retur_beli_list.php')) ?>'" class="btn btn-primary btn-flat"><i class="fa fa-arrow-left"></i> Kembali</button>
                                </div>
                                <div class="col-lg-6 text-right">
                                    ...
                                    <?php } ?>
                                    <?php echo nbs(5) ?>
                                    <!--<button type="button" class="btn <?php echo ($sql_ret->cetak == '1' ? 'btn-danger' : 'btn-primary') ?> btn-flat" onclick="window.location.href='<?php echo base_url('transaksi/cetak_nota.php?id=' . $this->input->get('id')) ?>'"><i class="fa fa-print"></i> <?php echo ($sql_ret->cetak == '1' ? 'Cetak Ulang Nota' : 'Cetak Nota') ?></button>-->
                                </div>
                            </div>
                        </div>
                    </div>
