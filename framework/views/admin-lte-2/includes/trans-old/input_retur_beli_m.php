                                ...
                                <div class="col-md-6">                                    
                                    <table class="table table-striped">
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle;">
                                                <div class="form-group <?php echo (!empty($hasError['kode']) ? 'has-error' : '') ?>">
                                                    <?php echo form_input(array('id' => 'no_nota', 'name' => 'no_nota', 'class' => 'form-control pull-right', 'readonly'=>'TRUE', 'value'=>(isset($_GET['no_nota']) ? $sql_pemb->no_nota : ''))) ?>
                                                </div>                                                
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <th style="vertical-align: middle;">:</th>
                                            <td style="vertical-align: middle;">
                                                <?php echo (!empty($sql_pemb->jml_gtotal) ? ($sql_pemb->jml_bayar > 0 ? general::format_angka($sql_pemb->jml_kurang) : general::format_angka($sql_pemb->jml_gtotal)) : 0); ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th style="vertical-align: middle; width: 200px;">
