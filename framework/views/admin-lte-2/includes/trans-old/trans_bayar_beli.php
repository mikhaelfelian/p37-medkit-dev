                        ...
                        <div class="box-body table-responsive">
                            ...
                            <table class="table table-striped">
                                ...
                                <tr>
                                    <th>Status PPN</th>
                                    <th>:</th>
                                    <td><button type="button" id="btnEditPPn" class="btn btn-<?php echo ($pemb->status_ppn == '1' ? 'danger' : 'primary'); ?> btn-flat" onclick="window.location.href='<?php echo site_url('page=transaksi&act=set_nota_beli_ppn_upd&id='.$this->input->get('id').'&ppn='.($pemb->status_ppn == '1' ? '0' : '10')); ?>'"><i class="fa fa-<?php echo ($pemb->status_ppn == '1' ? 'remove' : 'plus')?>"></i> PPN</button></td>
