                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle;">
                                                <div class="input-group date">
                                                    ...
                                                    <?php echo form_input(array('id' => 'harga', 'name' => 'harga', 'class' => 'form-control pull-right', 'value'=>$hrg_satuan)) ?>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tbody>
                                            <?php if (!empty($sql_pemb_det)) { ?>
                                                ...
                                                <?php $sql_prod = $this->db->where('kode', $penj_det->kode)->get('tbl_m_produk')->row(); ?>
                                                    <tr>
                                                        <td class="text-center">
                                                            <?php echo anchor(base_url('transaksi/trans_retur_beli.php?id='.$this->input->get('id').'&no_nota='.$this->input->get('no_nota').'&id_produk='.general::enkrip($sql_prod->id)), '<i class="fa fa-mail-forward"></i>', 'class="text-danger" onclick="return confirm(\'Retur [' . $penj_det->produk . '] ?\')"') ?>
                                                        </td>
