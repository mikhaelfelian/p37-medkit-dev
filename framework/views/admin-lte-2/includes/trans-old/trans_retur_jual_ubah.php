                    ...
                    <div class="box box-warning">
                        ...
                        <div class="box-body">
                            <div class="row">
                                    ...
                                    <table class="table table-striped">
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle;">                                   
                                                <?php echo anchor(base_url('transaksi/trans_jual_det.php?id='.$this->input->get('no_nota')), $sql_penj->kode_nota_dpn.''.general::dekrip($this->input->get('no_nota')).'/'.$sql_penj->kode_nota_blk) ?>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <th style="vertical-align: middle;">:</th>
                                            <td style="vertical-align: middle;">
                                                <input type="checkbox" name="status_ppn" value="1" <?php echo ($sql_ret->status_ppn == 1 ? 'checked="TRUE"' : '') ?>> Termasuk PPN
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="vertical-align: middle; text-align: right;" colspan="3">
                                                ...
                                                <?php if(!empty($sess_ret_beli)){ ?>
                                                    <button type="button" class="btn btn-warning btn-flat" onclick="window.location.href='<?php echo base_url('transaksi/set_retur_jual_batal.php?no_nota='.$this->input->get('no_nota')) ?>'">Batal</button>
                                                <?php } ?>
                                ...
                                <?php echo form_open_multipart(base_url('transaksi/cart_retur_jual_update.php')) ?>
                                ...
                                <div class="col-md-6">                                    
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            <th style="vertical-align: middle;">Harga Lusin</th>
                                            <th style="vertical-align: middle;">:</th>
                                            <td style="vertical-align: middle;">
                                                <div class="input-group date">
                                                    ...
                                                    <?php echo form_input(array('id' => 'harga', 'name' => 'harga', 'class' => 'form-control pull-right', 'value' => $sql_penj_det_row->harga)) ?>
                                                </div>
                                            </td>
                                        </tr>                                        
                                        <tr>
                    ...
                    <div class="col-lg-12">
                        <div class="box box-warning" id="data_pelanggan">
                                                ...
                                                <?php $produk  = $this->db->where('kode', $penj_det->kode)->get('tbl_m_produk')->row(); ?>
                                                    <tr>
                                                        <td class="text-center">
                                                            <?php echo anchor(base_url('transaksi/cart_retur_jual_ubah_hapus.php?id='.$this->input->get('id').'&no_nota='.$this->input->get('no_nota').'&id_retur_det='.general::enkrip($penj_det->id)), '<i class="fa fa-remove"></i>', 'class="text-danger" onclick="return confirm(\'Hapus [' . $penj_det->produk . '] ?\')"') ?>
                                                        </td>
                            ...
                            <div class="box-footer">
                                <button type="button" class="btn btn-danger btn-flat pull-left" onclick="window.location.href='<?php echo base_url('transaksi/set_nota_batal.php?term=retur_jual'.(isset($_GET['id']) ? '&id='.$this->input->get('id') : '').(isset($_GET['no_nota']) ? $this->input->get('no_nota') : '')) ?>'"><i class="fa fa-remove"></i> Batal</button>
                                <?php if (!empty($sql_ret_det)) { ?>
                                    <?php echo form_open(base_url('transaksi/set_retur_jual_proses_update.php')) ?>
                        ...
                        <div class="box box-warning" id="data_pelanggan">
                            <div class="box-body">
                                    <table class="table table-striped">
                                        <thead>
                                            <tr>
                                                <th colspan="8">Nota Penjualan <?php echo $sql_penj->kode_nota_dpn.''.general::dekrip($this->input->get('no_nota')).'/'.$sql_penj->kode_nota_blk ?></th>
                                            </tr>
                                            <tr>
                                                <th class="text-right"></th>
                                                <th class="text-center">No</th>
                                        ...
                                        <tbody>
                                            <?php if (!empty($sql_penj_det)) { ?>
                                                ...
                                                <?php $sql_prod = $this->db->where('kode', $penj_det->kode)->get('tbl_m_produk')->row(); ?>
                                                    <tr>
                                                        <td class="text-center">
                                                            <?php echo anchor(base_url('transaksi/trans_retur_jual_ubah.php?id='.$this->input->get('id').'&no_nota='.$this->input->get('no_nota').'&id_produk='.general::enkrip($sql_prod->id)), '<i class="fa fa-mail-forward"></i>', 'class="text-danger" onclick="return confirm(\'Retur [' . $penj_det->produk . '] ?\')"') ?>
                                                        </td>
