    ...
    <div class="container">        
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Form Retur Penjualan</li>
            </ol>
        </section>
                ...
                <div class="col-lg-12">
                    <div class="box box-warning">
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-shopping-cart"></i> Form Retur Penjualan</h3>
                        </div>
                        <div class="box-body">
                            <div class="row">
                                <?php echo form_open_multipart(base_url('transaksi/'.(!empty($_GET['id']) ? 'set_retur_jual_update' : 'set_retur_jual').'.php'), 'autocomplete="off"') ?>
                                    ...
                                    <table class="table table-striped">
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle;">                                   
                                                <?php echo anchor(base_url('transaksi/trans_jual_det.php?id='.$this->input->get('no_nota')), $sql_penj->kode_nota_dpn.''.$sql_penj->no_nota.'/'.$sql_penj->kode_nota_blk) ?>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <th style="vertical-align: middle;">:</th>
                                            <td style="vertical-align: middle;">
                                                <?php echo '['.$sql_sales->kode.'] '.$sql_sales->nama ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="vertical-align: middle; text-align: right;" colspan="3">
                                                <?php $sess_ret_beli = $this->session->userdata('trans_retur_jual') ?>
                                                <?php if(!empty($sess_ret_beli)){ ?>
                                                <button type="button" class="btn btn-warning btn-flat" onclick="window.location.href='<?php echo base_url('transaksi/set_retur_jual_batal.php?id='.$this->input->get('id').'&no_nota='.$this->input->get('no_nota')) ?>'">Batal</button>
                                                <?php } ?>
                                                <button type="submit" class="btn btn-primary btn-flat">Set Retur Jual</button>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                                <?php echo form_close() ?>
                                <?php if (!empty($sess_ret_jual)) { ?>
                                <?php // if (isset($_GET['id_produk'])) { ?>
                                <?php echo form_open_multipart(base_url('transaksi/cart_retur_jual_simpan.php')) ?>
                                    ...
                                    <table class="table table-striped">
                                            ...
                                            <td style="vertical-align: middle;">
                                                <div id="bag-pelanggan" class="<?php echo (!empty($hasError['pelanggan']) ? 'has-error' : '') ?>">
                                                    <div class="input-group date">
                                                        <?php echo form_input(array('id' => 'jml', 'name' => 'jml', 'class' => 'form-control', 'style' => 'width: 100px;', 'value'=> (!empty($sql_penj_det_row->jml) ? $sql_penj_det_row->jml : 1))) ?>
                                                        <?php if(isset($_GET['id_produk'])){ ?>
                                                            <span class="input-group-addon no-border text-bold"><?php echo nbs() ?></span>
                                                            <select id="satuan" name="satuan" class="form-control">
                                                                <?php foreach ($sql_produk_sat as $satuan){ ?>
                                                                    <option value="<?php echo $satuan->satuan ?>" <?php echo $sql_penj_det_row->satuan == $satuan->satuan ? 'selected' : '' ?>><?php echo ucwords($satuan->satuan).($satuan->satuan != $sql_satuan->satuanTerkecil ? ' ('.$satuan->jml.' '.$sql_satuan->satuanTerkecil.')' : '') ?></option>
                                                                <?php } ?>
                                                            </select>
                                                            <span class="input-group-addon no-border text-bold"><?php echo nbs() ?></span>
                                                        <?php } ?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle;">
                                                <div class="input-group date">
                                                    ...
                                                    <?php echo form_input(array('id' => 'harga', 'name' => 'harga', 'class' => 'form-control pull-right', 'value'=>$harga_bl_sat)) ?>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle;">
                                                <div class="input-group">
                                                    <?php echo form_input(array('id' => 'disk1', 'name' => 'disk1', 'class' => 'form-control', 'value'=>$sql_penj_det_row->disk1)) ?>
                                                    <span class="input-group-addon no-border text-bold">+</span>
                                                    <?php echo form_input(array('id' => 'disk2', 'name' => 'disk2', 'class' => 'form-control', 'value'=>$sql_penj_det_row->disk2)) ?>
                                                    <span class="input-group-addon no-border text-bold">+</span>
                                                    <?php echo form_input(array('id' => 'disk3', 'name' => 'disk3', 'class' => 'form-control', 'value'=>$sql_penj_det_row->disk3)) ?>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="vertical-align: middle;" colspan="3">
                                                <?php echo form_radio(array('name'=>'tipe', 'value'=>'1', 'checked'=>'TRUE')) ?> Potong Nota
                                                <?php echo nbs(4) ?>
                                                <?php echo form_radio(array('name'=>'tipe', 'value'=>'2')) ?> Tukar Barang
                                                <?php echo nbs(4) ?>
                                                <?php echo form_radio(array('name'=>'tipe', 'value'=>'3')) ?> Pengganti
                                            </td>
                                        </tr>
                                        -->
                                        <?php if(isset($_GET['id_produk'])){ ?>
            ...
            <div class="row">                
                    <div class="col-lg-12">
                        <div class="box box-warning" id="data_pelanggan">
                            <div class="box-body">
                                <?php
                                $tglm = explode('-', $sql_penj->tgl_masuk);
                                $tglj = explode('-', $sql_penj->tgl_keluar);                                
                                ?>
                                <table class="table table-striped">
                                    <tr>
                                        <th>Nama Customer</th>
                                        <th>:</th>
                                        <td><?php echo ucwords($sql_pelanggan->nama) ?></td>
                                    ...
                                    <tr>
                                        ...
                                        <th>:</th>
                                        <td colspan="4"><?php echo strtoupper($sql_penj->kode_fp) ?></td>
                                    </tr>
                                    -->
                                </table>
                                <hr/>
                                    <table class="table table-striped">
                                        <thead>
                                            <tr>
                                                <th colspan="8">Nota Barang Retur</th>
                                            </tr>
                                            <tr>
                                                ...
                                                <?php $produk  = $this->db->where('kode', $penj_det->kode)->get('tbl_m_produk')->row(); ?>
                                                    <tr>
                                                        <td class="text-center">
                                                            <?php echo anchor(base_url('transaksi/cart_retur_jual_hapus.php?id='.$this->input->get('id').'&no_nota='.$this->input->get('no_nota').'&id_retur_det='.general::enkrip($penj_det->id)), '<i class="fa fa-remove"></i>', 'class="text-danger" onclick="return confirm(\'Hapus [' . $penj_det->produk . '] ?\')"') ?>
                                                        </td>
                                                        ...
                                                        <td class="text-left"><?php echo general::status_retur($penj_det->status_retur) ?></td>
                                                    </tr>
                                                <?php } ?>
                                            <?php }else{ ?>
                                                <tr>
                            ...
                            <div class="box-footer">
                                <button type="button" class="btn btn-danger btn-flat pull-left" onclick="window.location.href='<?php echo base_url('transaksi/set_retur_jual_batal.php?id='.$this->input->get('id').'&no_nota='.$this->input->get('no_nota')) ?>'"><i class="fa fa-remove"></i> Batal</button>
                                <?php if (!empty($sql_ret_det)) { ?>
                                    <?php echo form_open(base_url('transaksi/set_retur_proses.php')) ?>
                        ...
                        <div class="box box-warning" id="data_pelanggan">
                            <div class="box-body">
                                    <table class="table table-striped">
                                        <thead>
                                            <tr>
                                                <th colspan="8">Nota Penjualan <?php echo $sql_penj->kode_nota_dpn.''.sprintf("%05s", (general::dekrip($this->input->get('no_nota')))).'/'.$sql_penj->kode_nota_blk ?></th>
                                            </tr>
                                            <tr>
                                                <th class="text-right"></th>
                                                <th class="text-center">No</th>
                                        ...
                                        <tbody>
                                            <?php if (!empty($sql_penj_det)) { ?>
                                                ...
                                                <?php $sql_prod = $this->db->where('kode', $penj_det->kode)->get('tbl_m_produk')->row(); ?>
                                                    <tr>
                                                        <td class="text-center">
                                                            <?php echo anchor(base_url('transaksi/trans_retur_jual.php?id='.$this->input->get('id').'&no_nota='.$this->input->get('no_nota').'&id_produk='.general::enkrip($sql_prod->id)), '<i class="fa fa-mail-forward"></i>', 'class="text-danger" onclick="return confirm(\'Retur [' . $penj_det->produk . '] ?\')"') ?>
                                                        </td>
...
//  Autocomplete buat Barang
  $('#kode').autocomplete({
      ...
      select: function (event, ui) {
          ...
          window.location.href = "<?php echo base_url('transaksi/trans_retur_jual.php?id='.$this->input->get('id').'&no_nota='.$this->input->get('no_nota')) ?>&id_produk="+ui.item.id;
