                ...
                <div class="box box-warning">
                    ...
                    <div class="box-body table-responsive">
                        ...
                        <table class="table table-responsive">
                            ...
                            <?php echo form_open(base_url('pajak/set_cari_penj.php')) ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(akses::hakSA() == TRUE OR akses::hakOwner() == TRUE){ ?>
                                                    ...
                                                    <?php echo anchor(base_url('pajak/trans_jual_hapus.php?id='.general::enkrip($penj->id)), '<i class="fa fa-remove"></i> Hapus', 'class="label label-danger" onclick="return confirm(\'Hapus ['.$penj->kode_nota_dpn.$penj->no_nota.(!empty($penj->kode_nota_blk) ? '/'.$penj->kode_nota_blk : '').'] ?\')"') ?>
                                                <?php } ?>
