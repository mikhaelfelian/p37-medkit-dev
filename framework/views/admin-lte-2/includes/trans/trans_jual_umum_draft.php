                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <table class="table table-striped">
                                        ...
                                        <?php $aid = general::enkrip($draft->id); ?>
                                        <tr>
                                            <td><?php echo anchor(base_url('transaksi/trans_jual_umum_draft.php?id='.general::enkrip($draft->id)), $draft->no_nota.(!empty($draft->kode_nota_blk) ? '/'.$draft->kode_nota_blk : ''), 'class="'.($_GET['id'] == $aid ? 'text-success text-bold' : '').'"') ?></td>
                                ...
                                <?php echo form_close() ?>
                                <?php if (!empty($no_nota)) { ?>
                                <?php echo form_open_multipart(base_url('transaksi/cart_jual_simpan_draft.php')) ?>
                            ...
                            <div class="box-body">
                                ...
                                <table class="table table-striped">
                                    <tr>
                                        <th>Nama Customer</th>
                                        <th>:</th>
                                        <td><?php echo ucwords($sql_customer->nama) ?></td>
                                        ...
                                        <tbody>
                                            <?php if (!empty($sql_penj_det)) { ?>
                                                ...
                                                <?php 
                                                     ...
                                                     $jml_tot        = $jml_tot + $subtotal; //($penj_det['price'] * $penj_det['qty']);
                                                     $jml_pot        = $jml_pot + ($penj_det->potongan + $penj_det->diskon);
//                                                     $jml_tot_diskon = $jml_tot_diskon + ($penj_det['options']['diskon'] * $penj_det['qty']);
                                                     $jml_subtotal   = $jml_subtotal + $subtotal;
                                                ?>
                                                    <tr>
                                                        <td class="text-right" style="vertical-align: middle;">
                                                            <?php echo anchor(base_url('transaksi/cart_jual_hapus_draft.php?id=' . general::enkrip($penj_det->id) . '&no_nota=' . general::enkrip($penj_det->id_penjualan)), '<i class="fa fa-remove"></i>', 'class="text-danger" onclick="return confirm(\'Hapus [' . $penj_det->produk . '] ?\')"') ?>
                                                        </td>
                                                        ...
                                                        <td class="text-right" style="width: 50px;">
                                                            <?php echo form_open(base_url('transaksi/cart_jual_update_draft.php')) ?>
                                                            <?php echo form_hidden('no_nota', $_GET['id']) ?>
                                                            <?php echo form_hidden('id_cart', general::enkrip($penj_det->id)) ?>
                                                        ...
                                                        <td class="text-left" style="width: 150px; vertical-align: middle;">
                                                            ...
                                                            <!--<select id="satuan" name="satuan" class="form-control">-->
                                                                ...
                                                                <?php // } ?>
                                                            <!--</select>-->
                                                            <?php echo $penj_det->satuan.' '.$penj_det->keterangan ?>
                                                        </td>
                                                        <td style="vertical-align: middle;">
                                                            <!--<input type="checkbox" id="harga_ds" name="harga_ds" style="bottom: 190px;" value="1"> Harga DS-->
                                                        </td>
                                                ...
                                                <?php } ?>
                                                <?php $jml_gtotal = $jml_subtotal - (!empty($sess_pot['jml_retur']) ? $sess_pot['jml_retur'] : 0); ?>
                                                <?php echo form_open(base_url('transaksi/set_nota_bayar_draft.php'), 'id="frm_totalx"') ?>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <th  class="text-right" style="width: 200px;">
                                                        <?php if(!empty($sess_pot['jml_retur'])){ ?>
                                                        <div class="input-group date">
                                                            <div class="input-group-addon">
                                                                Rp.
                                                            </div>
                                                            <?php echo form_input(array('id' => 'jml_retur', 'name' => 'jml_retur', 'class' => 'form-control pull-right text-right', 'value'=>(!empty($sess_pot['jml_retur']) ? $sess_pot['jml_retur'] : '0'), 'readonly'=>'TRUE')) ?>
                                                        </div>
                                                        <?php }else{ ?>
                                                                <?php echo anchor(base_url('transaksi/data_retur_jual_list.php?id='.$this->input->get('id').'&route=transaksi/trans_jual_umum_draft.php'), 'Cari Retur') ?>
                                                        <?php } ?>
                                                    </th>
                                                </tr>
                                                <?php if(!empty($sess_pot['jml_retur'])){ ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <th  class="text-right" style="width: 200px;">
                                                        <div class="input-group date">
                                                            ...
                                                            <?php echo form_input(array('id' => 'jml_subtotal', 'name' => 'jml_subtotal', 'class' => 'form-control pull-right text-right', 'readonly' => 'TRUE', 'value' => general::format_angka($jml_gtotal))) ?>
                                                        </div>
                                                    </th>
                                                </tr>
                            ...
                            <div class="box-footer text-right">
                                <button type="button" class="btn btn-danger btn-flat pull-left" onclick="window.location.href='<?php echo base_url('transaksi/set_nota_batal_draft.php?id='.$this->input->get('id').'&route=data_penj_list.php') ?>'"><i class="fa fa-remove"></i> Hapus</button>
                                <?php if (!empty($sql_penj_det)) { ?>
                                    <?php echo form_hidden('no_nota', $_GET['id']) ?>
...
$(function () {
  ...
  $("#jml_ongkir").keyup(function(){
        ...
        var jml_retur   = $('#jml_retur').val().replace(/[.]/g,"");
        var jml_biaya   = $('#jml_biaya').val().replace(/[.]/g,"");
        
        var jml_subtotal = ((parseFloat(Math.round(jml_total)) - parseFloat(jml_diskon) - parseFloat(jml_retur)) + parseFloat(jml_biaya) + parseFloat(jml_ongkir));
  ...
  $("#jml_diskon").keyup(function(){
      ...
      var jml_biaya   = $('#jml_biaya').val().replace(/[.]/g,"");
      var jml_retur   = $('#jml_retur').val().replace(/[.]/g,"");
      var jml_gtotal  = (parseFloat(jml_total) - parseFloat(jml_diskon) - parseFloat(jml_retur)) + parseFloat(jml_ongkir) + parseFloat(jml_biaya);
      var jml_bayar   = $('#jml_bayar').val().replace(/[.]/g,"");
      var jml_kembali = parseFloat(Math.round(jml_bayar)) - parseFloat(jml_gtotal);
...
<?php if (!empty($no_nota)) { ?>
      ...
      $('#kode').autocomplete({
          ...
          select: function (event, ui) {
              ...
              $('#jml').val('1');
              window.location.href = "<?php echo base_url('transaksi/trans_jual_umum_draft.php?id='.$this->input->get('id')) ?>&id_produk="+ui.item.id+"&harga="+ui.item.harga; 
