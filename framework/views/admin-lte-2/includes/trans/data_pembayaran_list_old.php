                ...
                <div class="box box-warning">
                    ...
                    <div class="box-body table-responsive no-padding">
                        ...
                        <table class="table table-responsive">
                            ...
                            <?php echo form_open(base_url('transaksi/set_cari_penj_bayar.php'), 'autocomplete="off"') ?>
                                ...
                                if (!empty($penj)) {
                                    ...
                                    foreach ($penj as $penj) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo anchor(base_url('transaksi/trans_jual_det.php?id='.general::enkrip($penj->id).'&route=transaksi/data_pemb_jual_list.php'), $penj->kode_nota_dpn.$penj->no_nota.(!empty($penj->kode_nota_blk) ? '/'.$penj->kode_nota_blk : ''), 'class="text-default"') ?></td>
                                            <td><?php echo $tgl ?></td>
