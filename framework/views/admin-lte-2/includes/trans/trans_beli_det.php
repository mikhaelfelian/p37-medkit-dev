                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body table-responsive">
                            ...
                            <table class="table table-striped">
                                ...
                                <?php if($sql_beli->status_ppn == '2'){ ?>
                                <tr>
                                    <th colspan="7" class="text-right" style="vertical-align: middle;">
                                    </th>
                                    <th class="text-right" style="vertical-align: middle;">DPP</th>
                                    <th  class="text-right" style="width: 200px;">
                                        <div class="input-group date">
                                            <div class="input-group-addon">
                                                Rp.
                                            </div>
                                            <?php echo form_input(array('id' => 'jml_dpp', 'name' => 'jml_ppn', 'class' => 'form-control pull-right text-right', 'readonly' => 'TRUE', 'value' => $sql_beli->jml_subtotal - $sql_beli->jml_ppn)) ?>
                                        </div>
                                    </th>
                                </tr>
                                <?php } ?>
                        ...
                        <div class="box-footer">
                            <div class="row">
                                <div class="col-lg-6">
                                    <button type="button" onclick="window.location.href = '<?php echo base_url((isset($_GET['route']) ? $this->input->get('route') : 'transaksi/data_pembelian_list.php')) ?>'" class="btn btn-primary btn-flat"><i class="fa fa-arrow-left"></i> Kembali</button>
                                </div>
