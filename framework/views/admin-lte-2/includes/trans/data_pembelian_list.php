                ...
                <div class="box box-warning">
                    ...
                    <div class="box-body table-responsive">
                        ...
                        <table class="table table-responsive">
                            ...
                            <?php echo form_open(base_url('transaksi/set_cari_pemb.php'), 'autocomplete="off"') ?>
                            ...
                            <tbody>                                
                                <tr>
                                    ...
                                    <td><?php echo form_input(array('id' => 'tgl_bayar', 'name' => 'tgl_bayar', 'class' => 'form-control')) ?></td>
                                    <td>
                                    ...
                                    <td>
                                        <select name="filter_bayar" class="form-control">
                                ...
                                if (!empty($penj)) {
                                    ...
                                    foreach ($penj as $penj) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $this->tanggalan->tgl_indo($penj->tgl_keluar) ?></td>
