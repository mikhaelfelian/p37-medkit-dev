                ...
                <div class="box box-warning">
                    ...
                    <div class="box-body table-responsive no-padding">
                        ...
                        <table class="table table-responsive">
                            ...
                            <?php echo form_open(base_url('cart/set_cari_trans.php')) ?>
                                ...
                                if (!empty($penj)) {
                                    ...
                                    foreach ($penj as $penj) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo anchor(base_url('cart/trans_detail.php?id='.general::enkrip($penj->id)), '#' . $penj->no_nota . '@' . $this->db->where('id', $penj->id_app)->get('tbl_pengaturan_cabang')->row()->keterangan, 'class="text-default"') ?></td>
                                            ...
                                            <td>
                                                ...
                                                <?php }else{ ?>
                                                    <?php echo anchor(base_url('cart/form_pengambilan.php?id='.general::enkrip($penj->id)), '<i class="fa fa-check-circle text-success"></i> ', 'class="text-default"') ?>
                                                <?php } ?>
                                            </td>
                                            <td>
