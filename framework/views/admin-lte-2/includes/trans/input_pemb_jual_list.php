                ...
                <div class="box box-warning">
                    ...
                    <div class="box-body table-responsive">
                        ...
                        <table class="table table-responsive">
                            ...
                            <?php echo form_open('page=transaksi&act=set_cari_penj_bayar', 'autocomplete="off"') ?>
                            ...
                            <tbody>                                
                                <tr>
                                    <td></td>
                                    <td>
                                        <?php echo form_input(array('id' => 'cari_nota', 'name' => 'no_nota', 'class' => 'form-control')) ?>
                                        <input type="hidden" id="nota" name="nota">
                                    </td>
                                    <!--<td><?php // echo form_input(array('id' => 'tgl', 'name' => 'tgl', 'class' => 'form-control')) ?></td>-->
                                    <td>
                                        <?php echo form_input(array('id' => 'tgl', 'name' => 'tgl', 'class' => 'form-control')) ?>
                                    </td>
                                    <td>
                                ...
                                if (!empty($penj)) {
                                    ...
                                    foreach ($penj as $penj) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo anchor(base_url('transaksi/input_pemb_jual.php?id='.general::enkrip($sess_jual['id']).'&no_nota='.general::enkrip($penj->id)), '<i class="fa fa-arrow-right"></i> Bayar', 'class="label label-success"').nbs() ?>
