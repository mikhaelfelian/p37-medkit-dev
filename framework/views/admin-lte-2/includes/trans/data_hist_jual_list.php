<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Data Riwayat Pembayaran <small>Penjualan</small></h1>
        <ol class="breadcrumb">
                        ...
                        <table class="table table-responsive">
                            <thead>
                                <tr>
                                    ...
                                    <!--<th style="width: 350px;">Pelanggan</th>-->
                                    <th colspan="2">#</th>
                                </tr>
                            </thead>
                            <form method="GET">
                            <?php // echo form_open(base_url('transaksi/set_cari_penj_plat.php'), 'autocomplete="off"') ?>
                                ...
                                if (!empty($penj)) {
                                    ...
                                    foreach ($penj as $penj) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo anchor(base_url('transaksi/data_hist_jual_det.php?id='.general::enkrip($penj->id)), sprintf('%05d', $penj->id)); ?>
                                            </td>
                                            <td><?php echo $tgl ?></td>
                                            <td class="text-right"><?php echo general::format_angka($penj->nominal) ?></td>
                                            <td></td>
                                            <td>
                                                <a class="label <?php echo ($sql_penj->cetak == '1' ? 'label-danger' : 'label-primary') ?> btn-flat" href = "<?php echo base_url('transaksi/cetak_rekap_jual2.php?id=' . general::enkrip($penj->id)) ?>"><i class="fa fa-print"></i> Rekap Byr</a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
