...
<!--                                    <th>Stat Pemb</th>
                            ...
                            <?php echo form_open(base_url('transaksi/set_cari_penj_retur.php', 'autocomplete="off"')) ?>
                                ...
                                if (!empty($retur)) {
                                    ...
                                    foreach ($retur as $retur) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo anchor(base_url('transaksi/trans_retur_jual_det.php?id='.general::enkrip($retur->id)), '#'.$retur->no_retur) ?></td>
                                            <td><?php echo $tgl[1] . '/' . $tgl[2] . '/' . $tgl[0] ?></td>
                                            <!--<td><?php echo anchor(base_url('transaksi/trans_jual_det.php?id='.general::enkrip($retur->id_penjualan).'&route=transaksi/'.$this->uri->segment(2)), $nota->kode_nota_dpn . $retur->no_nota, 'class="text-default"') ?></td>-->
