...
<div class="content-wrapper">
    <div class="container">        
        ...
        <section class="content">
                    ...
                    <div class="box box-warning">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <?php }else{ ?>
                                    <?php echo form_open_multipart(base_url('transaksi/set_pemb_beli.php'), 'autocomplete="off"') ?>
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tr>
                                                <td style="vertical-align: middle; text-align: right;" colspan="3">
                                                    <!--onclick="window.location.href='<?php echo site_url('page=transaksi&act=set_nota_batal&term=trans_byr_beli&route=input_pemb_beli.php') ?>'"-->
                                ...
                                <input type="hidden" id="id_beli" name="id_pembelian" value="<?php echo general::enkrip($sql_pemb->id) ?>">
                                ...
                                <div class="col-md-6">                                    
                                    <table class="table table-striped">
                                            ...
                                            <td style="vertical-align: middle;">
                                                <div class="input-group date">
                                                    <div class="form-group <?php echo (!empty($hasError['kode']) ? 'has-error' : '') ?>">
                                                        <?php echo form_input(array('id' => 'nota', 'name' => 'no_nota', 'class' => 'form-control pull-right', 'value'=>(isset($_GET['no_nota']) ? $sql_pemb->no_nota : ''))) ?>
                                                    </div>
                                                    <div class="input-group-addon">
                                                        <?php echo anchor(base_url('transaksi/input_pemb_beli_list.php?id='.general::enkrip($sess_beli['id'])), '<i class="fa fa-search"></i>', 'class=""') ?>
                                                    </div>                                                
                                                </div>                                                
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <th style="vertical-align: middle;"></th>
                                            <td style="vertical-align: middle;">
                                                <?php echo anchor(base_url('transaksi/input_pemb_beli_list.php?id='.general::enkrip($sess_beli['id'])), '<i class="fa fa-search"></i> Cari Nota', 'class="text-bold"') ?>                                           
                                            </td>
                                        </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="vertical-align: middle;">
                                                        <div class="input-group <?php echo (!empty($hasError['jml_diskon']) ? 'has-error' : '') ?>">
                                                            ...
                                                            <?php echo form_input(array('id' => 'nominal', 'name' => 'jml_subtotal', 'class' => 'form-control pull-right', 'readonly' => 'TRUE', 'value' => (!empty($sql_pemb->jml_gtotal) ? $sql_pemb->jml_gtotal : 0))) ?>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="vertical-align: middle;">
                                                        <div class="input-group <?php echo (!empty($hasError['jml_dibayar']) ? 'has-error' : '') ?>">
                                                            <div class="input-group-addon">Rp</div>
                                                            <?php echo form_input(array('id' => 'nominal', 'name' => 'jml_dibayar', 'class' => 'form-control pull-right', 'readonly' => 'TRUE', 'value' => (!empty($sql_pemb->jml_bayar) ? $sql_pemb->jml_bayar : 0))) ?>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="vertical-align: middle;">
                                                        <div class="input-group <?php echo (!empty($hasError['jml_diskon']) ? 'has-error' : '') ?>">
                                                            <div class="input-group-addon">Rp</div>
                                                            <?php echo form_input(array('id' => 'nominal', 'name' => 'jml_diskon', 'class' => 'form-control pull-right', 'value' => (!empty($sql_pemb->jml_potongan) ? $sql_pemb->jml_potongan : 0))) ?>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="vertical-align: middle;">
                                                        <div class="input-group <?php echo (!empty($hasError['jml_retur']) ? 'has-error' : '') ?>">
                                                            <div class="input-group-addon">Rp</div>
                                                            <?php echo form_input(array('id' => 'nominal', 'name' => 'jml_retur', 'class' => 'form-control pull-right', 'value' => (!empty($sql_pemb->jml_retur) ? $sql_pemb->jml_retur : 0))) ?>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="vertical-align: middle;">
                                                        <div class="input-group <?php echo (!empty($hasError['jml_diskon']) ? 'has-error' : '') ?>">
                                                            <div class="input-group-addon">Rp</div>
                                                            <?php echo form_input(array('id' => 'nominal', 'name' => 'jml_gtotal', 'class' => 'form-control pull-right', 'readonly' => 'TRUE', 'value' => (!empty($sql_pemb->jml_gtotal) ? $sql_pemb->jml_gtotal : 0))) ?>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="vertical-align: middle;">
                                                        <div class="input-group <?php echo (!empty($hasError['jml_diskon']) ? 'has-error' : '') ?>">
                                                            <div class="input-group-addon">Rp</div>
                                                            <?php echo form_input(array('id' => 'nominal', 'name' => 'jml_kurang', 'class' => 'form-control pull-right', 'readonly' => 'TRUE', 'value' => (!empty($sql_pemb->jml_kurang) ? $sql_pemb->jml_kurang : 0))) ?>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="vertical-align: middle;">
                                                        <select id="metode_bayar" name="metode" class="form-control">
                                                            ...
                                                            <?php foreach ($sql_platform as $pl) { ?>
            ...
            <div class="row">                
                    <div class="col-lg-12">
                        <?php echo form_open(base_url('transaksi/input_pemb_beli_proses.php')) ?>
                        <div class="box box-warning" id="data_pelanggan">
                            <div class="box-body  table-responsive">
                                <?php
                                $tglm = $this->tanggalan->tgl_indo($sess_beli['tgl_masuk']);
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <?php if (!empty($sql_pemb_det)) { ?>
                                                <?php $no = 1; $tot_penj = 0; $bagi = 0;?>
                                                <?php foreach ($sql_pemb_det as $penj_det) { ?>
                                                <?php $tot_penj = $tot_penj + $penj_det['options']['jml_bayar']; ?>
                                                ...
                                                <?php
                                                $jml_kurang = $penj_det['options']['jml_gtotal'] - $penj_det['options']['jml_bayar'];
                                                $jml_kembali= $penj_det['options']['jml_bayar'] - $penj_det['options']['jml_gtotal'];
                                                ?>
                                                    <tr>
                                                        <td class="text-center">
                                                            <?php echo anchor(base_url('transaksi/cart_jual_hapus.php?id=' . general::enkrip($penj_det['rowid']) . '&no_nota=' . general::enkrip($sess_beli['id']).'&route=transaksi/input_pemb_beli.php'), '<i class="fa fa-remove"></i>', 'class="text-danger" onclick="return confirm(\'Hapus [' . $penj_det['name'] . '] ?\')"') ?>
                                                        </td>
                                                        ...
                                                        <td class="text-right"><?php echo general::format_angka($penj_det['options']['jml_bayar']) ?></td>
                                                        <td class="text-right"><?php echo general::format_angka(($jml_kurang < 0 ? $jml_kembali : $jml_kurang)) ?></td>
                                                    </tr>
                                                    <?php $bagi++; ?>
                                                <?php } ?>
                                                <?php echo form_hidden('bagi', $bagi) ?>
                                                    <!--
                                                <tr>
                                                    <th class="text-right" colspan="5">
                                                        Total Bayar
                                                    </th>
                                                    <th class="text-right"><?php echo form_input(array('id' => 'nominal', 'name' => 'jml_bayar_tot', 'class' => 'form-control pull-right', 'value'=>$tot_penj, 'disabled'=>'TRUE')) ?> </th>
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="text-right"><?php echo form_input(array('id' => 'nominal', 'name' => 'jml_bayar_ret', 'class' => 'form-control pull-right', 'value'=>0)) ?> </th>
                                                    <th class="text-right" colspan="2"></th>
                                                </tr>
                                                <tr>
                                                    <th class="text-right" colspan="5">
                                                    ...
                                                    <th class="text-right"><?php echo form_input(array('id' => 'nominal', 'name' => 'jml_bayar_pot', 'class' => 'form-control pull-right', 'value'=>0)) ?> </th>
                                                    <th class="text-right" colspan="2"></th>
                                                </tr>
                                                <tr>
                                                    <th class="text-right" colspan="5">
                                                ...
                                                <tr id="bank">
                                                    <th class="text-right" style="vertical-align: middle;" colspan="5">
                                                        Nama Bank
                                                    </th>
                                                    <th class="text-right">
                                                        <?php echo form_input(array('name' => 'platform', 'class' => 'form-control pull-right text-right', 'placeholder' => 'Nama Bank ...')) ?>
                            ...
                            <div class="box-footer">
                                <button type="button" class="btn btn-danger btn-flat pull-left" onclick="window.location.href='<?php echo base_url('transaksi/set_nota_batal.php?term=byr_beli&route=input_pemb_beli.php') ?>'"><i class="fa fa-remove"></i> Batal</button>
                                <?php if (!empty($sql_pemb_det)) { ?>
...
<?php // if(isset($_GET['id'])){ ?>  
  ...
  $('#nota').autocomplete({
      source: function (request, response) {
          $.ajax({
              url: "<?php echo base_url('transaksi/json_nota_beli.php') ?>",
              dataType: "json",
              data: {
                  term: request.term
              },
      ...
      select: function (event, ui) {
          var $itemrow = $(this).closest('tr');
          //Populate the input fields from the returned values
          $itemrow.find('#no_nota').val(ui.item.id);
          $('#id_beli').val(ui.item.id);
          $('#no_nota').val(ui.item.no_nota);
          window.location.href = "<?php echo base_url('transaksi/input_pemb_beli.php?id='.$this->input->get('id')) ?>&no_nota="+ui.item.no_notad; 
  ...
  //Format the list menu output of the autocomplete
      ...
      return $("<li></li>")
              .data("item.autocomplete", item)
              .append("<a>" + item.no_nota + " - " + item.jml_gtotal +"</a>")
              .appendTo(ul);
  };
<?php //  ?>
