                        ...
                        <div class="box-footer">
                            <div class="row">
                                ...
                                <div class="col-lg-6 text-right">
                                    ...
                                    <?php } ?>
                                    <?php echo nbs(5) ?>
                                    <button type="button" class="btn btn-primary btn-flat" onclick="window.location.href='<?php echo base_url('transaksi/cetak_nota_retbeli.php?id=' . $this->input->get('id')) ?>'"><i class="fa fa-print"></i> Cetak Nota Retur</button>
                                </div>
                            </div>
                        </div>
                    </div>
