            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="box box-warning">
                        ...
                        <div class="box-body">
                            <div class="row">
                                <?php echo form_open_multipart(base_url('transaksi/set_nota_beli_po.php'), 'autocomplete="off"') ?>
                                ...
                                <div class="col-md-6">                                    
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            <th style="vertical-align: middle;">Alamat Pengiriman</th>
                                            <th style="vertical-align: middle;">:</th>
                                            <td style="vertical-align: middle;">
                                                <?php echo form_input(array('id' => 'pengiriman', 'name' => 'pengiriman', 'class' => 'form-control pull-right')) ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="vertical-align: middle; text-align: right;" colspan="3">                                                
                                                <button type="reset" class="btn btn-warning btn-flat">Bersih</button>
                                                <button type="submit" class="btn btn-primary btn-flat">Set PO</button>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                                ...
                                <?php echo form_open_multipart(base_url('transaksi/cart_beli_simpan_po.php'), 'autocomplete="off"') ?>
                    ...
                    <div class="col-lg-12">
                        <div class="box box-warning" id="data_pelanggan">
                            <div class="box-body">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th>Keterangan</th>
                                        <th>:</th>
                                        <td><?php echo $sess_beli['keterangan'] ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <table class="table table-stripped">
                                        <thead>                                        
                                            <tr>
                                                ...
                                                <th class="text-center" colspan="2">Jml PO</th>
                                        ...
                                        <tbody>
                                            <?php if (!empty($sql_pemb_det)) { ?>
                                                ...
                                                <?php $sql_brg  = $this->db->select_sum('jml')->where('id', $pemb_det->id_produk)->get('tbl_m_produk_stok')->row() ?>
                                                <?php $sql_sat = $this->db->where('id', $sql_brg->id_satuan)->get('tbl_m_satuan')->row() ?>
                                                    <?php if($_GET['route'] == 'edit_produk'){ ?>
                                                        <?php echo form_open('page=transaksi&act=cart_beli_update_po', 'autocomplete="off"'); ?>
                                                        <?php echo form_hidden('id_barang', $this->input->get('id_produk')); ?>
                                                        <?php echo form_hidden('no_nota', $this->input->get('id')); ?>
                                                        <?php echo form_hidden('id', general::enkrip($pemb_det->id)); ?>
                                                        <tr>
                                                            <td class="text-center">
                                                                <?php echo anchor(base_url('transaksi/cart_beli_hapus_po.php?id=' . general::enkrip($pemb_det->id) . '&no_nota=' . general::enkrip($pemb_det->id_pembelian)), '<i class="fa fa-remove"></i>', 'class="text-danger" onclick="return confirm(\'Hapus [' . $pemb_det->produk . '] ?\')"') ?>
                                                            </td>
                                                            <td class="text-center"><?php echo $no++; ?></td>
                                                            <td class="text-left"><?php echo $pemb_det->kode ?></td>
                                                            <td class="text-left"><?php echo $pemb_det->produk ?></td>
                                                            <td class="text-center" style="width: 80px;"><?php echo form_input(array('id'=>'jml', 'name'=>'jml', 'class'=>'form-control text-right', 'value'=>$pemb_det->jml)) ?></td>
                                                            <td class="text-center" style="width: 120px;">
                                                                <select name="satuan" class="form-control">
                                                                    <?php $sql_satuan2     =$this->db->where('id', $pemb_det->id_satuan)->get('tbl_m_satuan')->row() ?>
                                                                    <?php $sql_produk_sat2 =$this->db->where('id_produk', $pemb_det->id_produk)->where('jml !=', '0')->get('tbl_m_produk_satuan')->result() ?>
                                                                    <?php foreach ($sql_produk_sat2 as $satuan){ ?>
                                                                        <option value="<?php echo $satuan->satuan ?>" <?php echo ($satuan->satuan == $pemb_det->satuan ? 'selected' : '') ?>><?php echo ucwords($satuan->satuan).($satuan->satuan != $sql_satuan2->satuanTerkecil ? ' ('.$satuan->jml.' '.$sql_satuan2->satuanTerkecil.')' : '') ?></option>
                                                                    <?php } ?>
                                                                </select>                                                                
                                                            </td>
                                                            <td class="text-center"><?php echo $sql_brg->jml.' '.$sql_sat->satuanTerkecil ?></td>
                                                            <td class="text-left" style="width: 150px;"><?php echo $pemb_det->keterangan_itm ?></td>
                                                            <td class="text-left"><button class="btn btn-success btn-flat"><i class="fa fa-save"></i></button></td>
                                                        </tr>
                                                    <?php echo form_close(); ?>
                                                    <?php }else{?>
                                                        <tr>
                                                            ...
                                                            <td class="text-left"><?php echo $pemb_det->kode ?></td>
                                                            <td class="text-left"><?php echo $pemb_det->produk ?></td>
                                                            <td class="text-center" colspan="2"><?php echo $pemb_det->jml.' '.$pemb_det->satuan.' '.$pemb_det->keterangan ?></td>
                                                            <td class="text-center"><?php echo $sql_brg->jml.' '.$sql_sat->satuanTerkecil ?></td>
                                                            <td class="text-left"><?php echo $pemb_det->keterangan_itm ?></td>
                                                            <td class="text-left"><?php echo anchor(base_url('transaksi/trans_beli_po.php?id='.$this->input->get('id').'&id_produk='.general::enkrip($pemb_det->id_produk).'&route=edit_produk'), '<i class="fa fa-edit"></i>', 'class="text-primary"') ?></td>
                                                        </tr>
                                                    <?php }?>
                                                <?php } ?>
                                            <?php }else{ ?>
                                                <tr>
                                                    <td colspan="10" class="text-center text-bold">Data barang kosong</td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
                            ...
                            <div class="box-footer">
                                <button type="button" class="btn btn-danger btn-flat pull-left" onclick="window.location.href='<?php echo base_url('transaksi/set_nota_batal.php?term=beli_po&route=transaksi/trans_beli_po.php') ?>'"><i class="fa fa-remove"></i> Batal</button>
                                <?php if (!empty($sql_pemb_det)) { ?>
                                    <?php echo form_open(base_url('transaksi/set_nota_beli_proses_po.php')) ?>
...
$(function () {
  ...
  $('#kode').autocomplete({
      ...
      select: function (event, ui) {
          ...
          window.location.href = "<?php echo base_url('transaksi/trans_beli_po.php?id='.$this->input->get('id')) ?>&id_produk="+ui.item.id; 
          //Give focus to the next input field to recieve input from user
          $('#jml').focus();
          return false;
      }
...
////
           ...
           $.ajax({
               ...
               success: function (data) {
                   ...
                   $('#alamat').val('');
//
//                   $("#bag-pelanggan").load("<?php echo base_url('transaksi/trans_beli_po.php') ?> #bag-pelanggan", function () {
//                       $(".select2").select2();
//                   });
                   $('#msg-success').show();
