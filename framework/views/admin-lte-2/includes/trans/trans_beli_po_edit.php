            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="box box-warning">
                        ...
                        <div class="box-body">
                            <div class="row">
                                <?php echo form_open_multipart(base_url('transaksi/set_nota_beli_update_po.php')) ?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle;">
                                                <div class="input-group">
                                                    <?php echo form_input(array('id' => 'jml', 'name' => 'jml', 'class' => 'form-control')) ?>
                    ...
                    <div class="col-lg-12">
                        <div class="box box-warning" id="data_pelanggan">
                                            ...
                                            <?php if (!empty($sql_pemb_det)) { ?>
                                                ...
                                                <?php foreach ($sql_pemb_det as $pemb_det) { ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><?php echo $pemb_det->jml.' '.$pemb_det->satuan.' '.$pemb_det->keterangan ?></td>
                            ...
                            <div class="box-footer">
                                <button type="button" class="btn btn-danger btn-flat pull-left" onclick="window.location.href='<?php echo base_url('transaksi/set_nota_batal.php?term=beli&route=transaksi/trans_beli_po.php') ?>'"><i class="fa fa-remove"></i> Batal</button>
                                <?php if (!empty($sql_pemb_det)) { ?>
