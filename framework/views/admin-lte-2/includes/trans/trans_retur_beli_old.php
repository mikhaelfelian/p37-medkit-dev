                    ...
                    <div class="box box-warning">
                        ...
                        <div class="box-body">
                            <div class="row">
                                <?php if (isset($_GET['id_produk'])) { ?>
                                    <div class="col-md-6">
                                        <table class="table table-striped table-responsive">
                                            ...
                                            <?php foreach ($sql_pemb_hst->result() as $prd_hist){ ?>
                                                <tr>
                                                    <td class="text-right"><?php echo $this->tanggalan->tgl_indo($prd_hist->tgl_simpan) ?></td>
                                                    <td class="text-right"><?php echo general::format_angka($prd_hist->harga) ?></td>
                                                    <td class="text-right"><?php echo (float)$prd_hist->disk1 ?>%</td>
                                                    <td class="text-right"><?php echo (float)$prd_hist->disk2 ?>%</td>
                                                    <td class="text-right"><?php echo (float)$prd_hist->disk3 ?>%</td>
                                                </tr>
                                        ...
                                        <table class="table table-striped">
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">                                   
                                                    <?php echo anchor(base_url('transaksi/trans_beli_det.php?id=' . $this->input->get('no_nota')), $sql_pemb->no_nota) ?>
                                                </td>
                                            </tr>
                                            <tr>
                                ...
                                <?php if (!empty($sess_ret_beli)) { ?>
                                <?php echo form_open_multipart(base_url('transaksi/cart_retur_beli_simpan.php'), 'autocomplete="off"') ?>
                                                    ...
                                                    <div class="input-group date">
                                                        ...
                                                        <?php if(isset($_GET['id_produk'])){ ?>
                                                            ...
                                                            <select name="satuan" class="form-control">
                                                                <option value="<?php echo $sql_satuan->satuanBesar ?>"><?php echo $sql_satuan->satuanBesar.($sql_satuan->jml != '1' ? ' ('.$sql_satuan->jml.' '.$sql_satuan->satuanTerkecil.')' : '') ?></option>
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle;">
                                                <div class="input-group date">
                                                    ...
                                                    <?php echo form_input(array('id' => 'harga', 'name' => 'harga', 'class' => 'form-control pull-right', 'value'=>$sql_pemb_hst->row()->harga)) ?>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
