<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Data Medical Checkup <small>List</small></h1>
        <ol class="breadcrumb">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(akses::hakSA() == TRUE OR akses::hakOwner() == TRUE){ ?>
                                                    ...
                                                    <?php echo anchor(base_url('transaksi/trans_jual_hapus.php?id='.general::enkrip($penj->id).'&status='.$this->input->get('status')), '<i class="fa fa-remove"></i> Hapus', 'class="label label-danger" onclick="return confirm(\'Hapus ['.$penj->kode_nota_dpn.$penj->no_nota.(!empty($penj->kode_nota_blk) ? '/'.$penj->kode_nota_blk : '').'] ?\')"') ?>
                                                <?php } ?>
                                                <?php if(akses::hakKasir() == TRUE OR akses::hakAdminM() == TRUE){ ?>
