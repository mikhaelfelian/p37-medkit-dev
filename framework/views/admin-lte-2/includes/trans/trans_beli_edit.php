            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="box box-warning">
                        ...
                        <div class="box-body">
                            <div class="row">
                                <?php echo form_open_multipart(base_url('transaksi/'.(!empty($_GET['id']) ? 'set_nota_beli_update' : 'set_nota_beli').'.php')) ?>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle;">
                                                <div class="input-group date">
                                                    ...
                                                    <?php echo form_input(array('id' => 'tgl_tempo', 'name' => 'tgl_tempo', 'class' => 'form-control pull-right', 'value' => $this->tanggalan->tgl_indo($sql_beli->tgl_keluar))) ?>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <th style="vertical-align: middle;">:</th>
                                            <td style="vertical-align: middle;">
                                                <?php echo form_input(array('id' => 'no_nota', 'name' => 'no_nota', 'class' => 'form-control pull-right', 'value'=>$sql_beli->no_nota)) ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <th style="vertical-align: middle;">:</th>
                                            <td style="vertical-align: middle;">
                                                <select name="status_ppn" class="form-control">
                                                    <option value="0" <?php echo ($sql_beli->status_ppn == '0' ? 'selected' : '') ?>>Non PPN</option>
                                                    <option value="1" <?php echo ($sql_beli->status_ppn == '1' ? 'selected' : '') ?>>Tambah PPN</option>
                                                    <option value="2" <?php echo ($sql_beli->status_ppn == '2' ? 'selected' : '') ?>>Include PPN</option>
                                                </select>
                                                <!--
                                                <?php // echo form_radio(array('id' => 'status_ppn', 'name' => 'status_ppn', 'value' => '0', 'checked'=>'false')) ?> Non PPN <?php echo nbs(2); ?>
                                        ...
                                        <tr>
                                            <td style="vertical-align: middle; text-align: right;" colspan="3">                                                
                                                <button type="button" class="btn btn-warning btn-flat" onclick="window.location.href='<?php echo base_url('transaksi/set_nota_batal.php?term=beli&route=transaksi/data_pembelian_list.php') ?>'">Batal</button>
                                ...
                                <?php echo form_open_multipart(base_url('transaksi/cart_beli_update.php')) ?>
                                ...
                                <input type="hidden" id="no_nota" name="no_nota" value="<?php echo $sql_beli->no_nota ?>">
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle;">
                                                <div class="input-group date">
                                                    ...
                                                    <?php echo form_input(array('id' => 'harga', 'name' => 'harga', 'class' => 'form-control pull-right', 'value'=>(isset($_GET['id_produk']) ? $sql_produk->harga_beli : ''))) ?>
                                                </div>
                                            </td>
                                        </tr>                                        
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle;">
                                                <div class="input-group">
                                                    <?php echo form_input(array('id' => 'disk1', 'name' => 'disk1', 'class' => 'form-control')) ?>
                                                    <span class="input-group-addon no-border text-bold">+</span>
                                                    <?php echo form_input(array('id' => 'disk2', 'name' => 'disk2', 'class' => 'form-control')) ?>
                                                    <span class="input-group-addon no-border text-bold">+</span>
                                                    <?php echo form_input(array('id' => 'disk3', 'name' => 'disk3', 'class' => 'form-control')) ?>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                    ...
                    <div class="col-lg-12">
                        <div class="box box-warning" id="data_pelanggan">
                                                ...
                                                <?php $tot_pemb = $tot_pemb + $pemb_det->subtotal ?>
                                                    <?php if($_GET['route'] == 'edit' AND $_GET['kd_produk'] == general::enkrip($pemb_det->id_produk)){ ?>
                                                        <tr>
                                                            ...
                                                            <!--<td class="text-right"><?php echo anchor(base_url('transaksi/trans_beli_edit.php?id='.$this->input->get('id').'&route=edit&kd_produk='.general::enkrip($penj_det->kode).'&aid='.general::enkrip($penj_det->id).'#item'.$penj_det->id),'<i class="fa fa-edit"></i>', 'onclick="return confirm(\'Lanjutkan ?\')"') ?></td>-->
                                                        </tr>
                                                    <?php }else{ ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center"><?php echo (float)$pemb_det->jml.' '.$pemb_det->satuan.' '.$pemb_det->keterangan ?></td>
                                                            <td class="text-center"><?php echo general::format_angka($pemb_det->disk1, 2) . (!empty($pemb_det->disk2) ? ' + ' . general::format_angka($pemb_det->disk2, 2) : '') . (!empty($pemb_det->disk3) ? ' + ' . general::format_angka($pemb_det->disk3, 2) : '') ?></td>
                                                            <td class="text-right"><?php echo (!empty($pemb_det->potongan) ? general::format_angka($pemb_det->potongan, 0) : '0') ?></td>
                                                            <td class="text-right"><?php echo general::format_angka($pemb_det->subtotal, 0) ?></td>
                                                            <td class="text-right"><?php echo anchor(base_url('transaksi/trans_beli_edit.php?id='.$this->input->get('id').'&route=edit&kd_produk='.general::enkrip($pemb_det->id_produk).'&aid='.general::enkrip($pemb_det->id).'#item'.$pemb_det->id),'<i class="fa fa-edit"></i>', '') ?></td>
                                                        </tr>
                                                    <?php } ?>
                                                <?php } ?>
                                                <tr>
                                                    ...
                                                    <th class="text-right"><?php echo general::format_angka($tot_pemb, 0) ?></th>
                                                </tr>
                                            <?php }else{ ?>
                                                <tr>
                            ...
                            <div class="box-footer">
                                <button type="button" class="btn btn-danger btn-flat pull-left" onclick="window.location.href='<?php echo base_url('transaksi/set_nota_batal.php?term=beli&route=transaksi/data_pembelian_list.php') ?>'"><i class="fa fa-remove"></i> Batal</button>
                                <?php if (!empty($sql_beli_det)) { ?>
                                    <?php echo form_open(base_url('transaksi/set_nota_beli_proses_upd.php')) ?>
...
$(function () {
  ...
  $('#kode').autocomplete({
      ...
      select: function (event, ui) {
          ...
          window.location.href = "<?php echo base_url('transaksi/trans_beli_edit.php?id='.$this->input->get('id')) ?>&id_produk="+ui.item.id; 
          //Give focus to the next input field to recieve input from user
          $('#jml').focus();
          return false;
      }
