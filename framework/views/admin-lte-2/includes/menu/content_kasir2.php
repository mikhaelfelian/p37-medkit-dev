            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-red">
                        ...
                        <a href="<?php echo base_url('transaksi/data_pemb_jual_list.php?filter_tgl_tempo=' . $tgl_tempo.'&jml='.$trans_jual_tmp) ?>" class="small-box-footer">Selebihnya <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="progress-group">
                                        <span class="progress-text">Produk Terjual</span>
