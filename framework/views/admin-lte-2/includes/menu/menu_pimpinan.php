...
<!--                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Sinkronisasi <span class="caret"></span></a>
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="<?php // echo base_url('sinkronisasi/data_export_list.php') ?>">Ekspor</a></li>
                                <li><a href="<?php // echo base_url('sinkronisasi/data_import_list.php') ?>">Impor</a></li>
                            </ul>
                        </li>-->
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <!--<li><a href="<?php echo base_url('laporan/data_keuangan.php') ?>">Keuangan</a></li>-->
                            </ul>
                        </li>
                        <li class="dropdown">
