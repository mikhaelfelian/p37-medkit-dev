<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Upload Stok Opname</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-lg-4">
                <?php echo form_open_multipart(base_url('gudang/data_opname_upload.php')) ?>
                <div class="box box-warning">
                    <div class="box-header with-border">
                        <h3 class="box-title">Form Stok Opname</h3>
                    </div>
                    <div class="box-body">
                        <?php echo $this->session->flashdata('gudang') ?>
                        <div class="form-group <?php echo (!empty($hasError['satBsr']) ? 'has-error' : '') ?>">
                            <label class="control-label">Upload</label>
                            <?php echo form_upload(array('id' => 'fupload', 'name' => 'fupload', 'class' => 'form-control', 'accept' => '.xls,.xlsx')) ?>
                        </div>                     
                        <div class="form-group <?php echo (!empty($hasError['satBsr']) ? 'has-error' : '') ?>">
                            <label class="control-label">Gd. Tujuan</label>
