<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Cetak <small>Stok Barang</small></h1>
        <ol class="breadcrumb">
                ...
                <div class="box box-warning">
                    ...
                    <div class="box-body">
                        ...
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item" src="<?php echo base_url('gudang/pdf_'.$uri.'.php?'.(!empty($filter_merk) ? 'filter_merk='.$filter_merk : '').(!empty($filter_kode) ? 'filter_kode='.$filter_kode : '').(!empty($filter_produk) ? '&filter_produk='.$filter_produk : '').(!empty($filter_hpp) ? '&filter_hpp='.$filter_hpp : '').(!empty($filter_harga) ? '&filter_harga='.$filter_harga : '').(!empty($jml) ? '&jml='.$jml : '')) ?>">
                            </iframe>
                        </div>
                    </div>
                    <div class="box-footer">
                        <div class="row">
                            <div class="col-lg-6">
                                <button type="button" onclick="window.location.href = '<?php echo base_url('gudang/'.$uri.'_list.php') ?>'" class="btn btn-primary btn-flat"><i class="fa fa-arrow-left"></i> Kembali</button>
                            </div>
                        </div>
                    </div>
                </div>
