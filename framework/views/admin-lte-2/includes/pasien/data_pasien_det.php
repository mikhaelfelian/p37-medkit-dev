                                        ...
                                        <div class="timeline timeline-inverse">
                                            <?php foreach ($rmi as $medc) { ?>
                                                ...
                                                <div>
                                                    ...
                                                    <div class="timeline-item">
                                                        <span class="time"><i class="far fa-clock"></i> <?php echo $this->tanggalan->wkt_indo($medc->tgl_masuk) ?></span>
                                                        <h3 class="timeline-header"><a href="#">ID <?php echo $medc->no_rm ?></a></h3>
                                                        <div class="timeline-body">
                                                            <?php echo (!empty($medc->diagnosa) ? html_entity_decode($medc->diagnosa) : 'Tidak Ada Diagnosa') ?>
                                                        </div>
                                                        <div class="timeline-footer">
                                                                ...
                                                                <table class="table table-striped">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <?php foreach ($sql_medc_file as $file) { ?>
                                                                            <?php
                                                                                $sql_medc   = $this->db->where('id', $file->id_medcheck)->get('tbl_trans_medcheck')->row();
                                                                                $no_rm      = strtolower($sql_pasien->kode_dpn) . $sql_pasien->kode;
                                                                                $files      = (!empty($file->file_name) ? realpath('./file/pasien/' . $no_rm . '/' . $file->file_name) : '');
                                                                                $berkas     = (file_exists($files) ? base_url('/file/pasien/' . $no_rm . '/' . $file->file_name) : '');
                                                                            ?>
                                                                            <tr>
                                                                                <td class="text-center"><?php echo $no; ?></td>
                                                                                <td class="text-left">
                                                                                    <a href="<?php echo (!empty($berkas) ? $berkas : '') ?>" data-toggle="lightbox" data-title="<?php echo strtolower($file->judul . ' - ' . $sql_pasien->nama_pgl) ?>">
                                    ...
                                    <?php if (!empty($rmfile)) { ?>
                                        <div class="timeline timeline-inverse">
                                            <?php foreach ($rmfile as $rmfile) { ?>
                                                <div class="time-label">
                                                    <span class="bg-danger">
                                                        <?php echo $this->tanggalan->tgl_indo3($rmfile->tgl_simpan).$rmfile->id_ap ?>
                                                    </span>
                                                </div>
                                                <?php
                                                ...
                                                ?>
                                                    <div>
                                                        ...
                                                        <div class="timeline-item">
                                                            <span class="time"><i class="far fa-clock"></i> <?php echo $this->tanggalan->wkt_indo($berkas->tgl_simpan).' '.$berkas->id ?></span>
                                                            <h3 class="timeline-header">
                                                                <?php if(!empty($foto)){ ?>
