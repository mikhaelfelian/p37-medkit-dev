                            ...
                            <tbody>
                                ...
                                if (!empty($sql)) {
                                    ...
                                    foreach ($sql as $file) {
                                        ...
                                        <?php $filename = base_url($file->file_name); // (file_exists($file) ? base_url($file->file_name) : $file->file_base64); ?>
                                        <tr>
                                            <td class="text-center"><?php echo $no++ ?>.</td>
                                            <td class="text-center"><?php echo $this->tanggalan->tgl_indo($file->tgl_simpan) ?></td>
                                            <td class="text-left">
                                                <?php if ($file->status == 1) { ?>
                                                    <?php if ($is_image == 'image') { ?>
                                                            <a href="<?php echo $filename ?>" data-toggle="lightbox" data-title="<?php echo strtolower($file->judul . ' - ' . $sql_pasien->nama_pgl) ?>">
                                                                <i class="fa fa-paperclip"></i> <?php echo $file->judul ?>
                                                            </a>
                                                    <?php } else { ?>
                                            ...
                                            <td class="text-left"><?php echo $this->ion_auth->user($file->id_user)->row()->first_name ?></td>
                                        </tr>
                                        <?php
                                    }
                                }
