<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Data Riwayat <small>Laboratorium</small></h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo site_url('page=home') ?>"><i class="fa fa-dashboard"></i> Beranda</a></li>
            <li class="active">Instalasi Laboratorium</li>
        </ol>
    </section>
                                ...
                                if (!empty($sql)) {
                                    ...
                                    foreach ($sql as $lab) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $this->tanggalan->tgl_indo($lab->tgl_simpan) ?></td>
                                            <td><?php echo $lab->no_lab ?></td>
                                            <td><?php echo $lab->no_sample ?></td>
                                            <td class="text-left"><?php echo $this->ion_auth->user($lab->id_analis)->row()->first_name ?></td>
                                            <td>                                                
                                                <a href="<?php echo base_url('pasien/surat/cetak_pdf_lab.php?id=' . general::enkrip($lab->id_medcheck) . '&id_lab=' . general::enkrip($lab->id) . '&status_ctk=1&type=D') ?>" target="_blank" class="label label-primary"><i class="fa fa-print"></i> Cetak</a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
