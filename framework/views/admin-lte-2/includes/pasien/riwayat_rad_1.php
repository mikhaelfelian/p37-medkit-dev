                                ...
                                if (!empty($sql)) {
                                    ...
                                    foreach ($sql as $rad) {
                                        ...
                                        <tr>
                                            ...
                                            <td>                                                
                                                <a href="<?php echo base_url('medcheck/surat/cetak_pdf_rad.php?id=' . general::enkrip($rad->id_medcheck) . '&id_rad=' . general::enkrip($rad->id) . '&status_ctk=1&type=D') ?>" target="_blank" class="label label-primary"><i class="fa fa-print"></i> Cetak</a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
