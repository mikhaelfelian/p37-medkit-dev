<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Data Pemasukan<small>Lain</small></h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-lg-4">
                <?php echo form_open(base_url('akuntability/data_pems_' . (isset($_GET['id']) ? 'update' : 'simpan') . '.php')) ?>
                <div class="box box-warning">
                    <div class="box-header with-border">
                        <h3 class="box-title">Form Pemasukan Lain - lain</h3>
                    </div>
                    <div class="box-body">
                    ...
                    <div class="box-footer">                        
                        <div class="row">
                            <div class="col-lg-6">
                                <button type="button" onclick="window.location.href = '<?php echo base_url('akuntability/data_pems_list.php') ?>'" class="btn btn-primary btn-flat">&laquo; Kembali</button>
                            </div>
