<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Jurnal Transaksi <small>Pembelian</small></h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo site_url('page=home') ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li class="active">Jurnal Pembelian</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <?php echo form_open(base_url('akuntability/set_jur_beli_cari.php'), '') ?>
                                ...
                                <div class="form-group <?php echo (!empty($hasError['akun_krd']) ? 'has-error' : '') ?>">
                                    ...
                                    <select name="akun_krd" class="form-control">
                                        ...
                                        <?php foreach ($akun2 as $akun2) { ?>
                                            <?php if ($akun2->id_akun_grup != 4 && $akun->id_akun_grup != 5) { ?>
...
//                                        $sales = $this->ion_auth->user($penj->id_user)->row();
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo anchor(base_url('transaksi/trans_beli_det.php?id=' . general::enkrip($penj->id)), $penj->kode_nota_dpn . $penj->no_nota, 'class="text-default"') ?></td>
                                            <td><?php echo $tgl[1] . '/' . $tgl[2] . '/' . $tgl[0] ?></td>
                                            <td class="text-right"><?php echo general::format_angka($penj->jml_gtotal) ?></td>
                                            <td>
                                                <?php echo anchor(base_url('akuntability/set_jur_beli_simpan.php?id='.general::enkrip($penj->id).'&akun_deb='.$this->input->get('akun_deb').'&akun_krd='.$this->input->get('akun_krd').'&bulan='.$this->input->get('bulan').'&tahun='.$this->input->get('tahun').'&route='.$this->uri->segment(1).'/'.$this->uri->segment(2)), '<i class="fa fa-plus"></i> Jurnal', 'class="label ' . ($penj->cetak == '1' ? 'label-danger' : 'label-warning') . '"') ?>
                                            </td>
                                        </tr>
                                        <?php
                                    }
