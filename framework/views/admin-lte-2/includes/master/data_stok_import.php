<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-lg-4">
                <?php echo form_open_multipart(base_url('master/data_stok_upload.php')) ?>
                <div class="box box-warning">
                    ...
                    <div class="box-body">
                        <div class="form-group <?php echo (!empty($hasError['satBsr']) ? 'has-error' : '') ?>">
                            ...
                            <?php echo form_upload(array('id' => 'fupload', 'name' => 'fupload', 'class' => 'form-control', 'accept' => 'application/vnd.ms-excel')) ?>
                        </div>                     
                    </div>
