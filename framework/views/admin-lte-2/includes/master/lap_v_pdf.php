            ...
            <div class="col-lg-12">
                <div class="box box-warning">
                    ...
                    <div class="box-body">
                        ...
                        ?>
                        <?php echo anchor(base_url('laporan/pdf_'.$uri.'.php?case='.$case.$parameter.(isset($_GET['filter_stok']) ? '&filter_stok='.$param : '')) . '&type=D', '<i class="fa fa-download"></i> Unduh', 'target=""') ?>
                        <?php echo nbs(2) ?>
                        <?php echo anchor(base_url('laporan/pdf_'.$uri.'.php?case='.$case.$parameter.(isset($_GET['filter_stok']) ? '&filter_stok='.$param : '')), '<i class="fa fa-external-link-square"></i> Fullscreen', 'target="_blank"') ?>
                        <?php echo br(2) ?>
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item" src="<?php echo base_url('laporan/pdf_'.$uri.'.php?case='.$case.$parameter.(isset($_GET['filter_stok']) ? '&filter_stok='.$param : '')) ?>">
                            </iframe>
                        </div>
                    </div>
