<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Data Pasiebn</li>
        </ol>
    </section>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($barang_sat as $satuan2) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left" style="vertical-align: middle;"><?php echo (!empty($sql_sat_prod->jml) ? $sql_sat_prod->jml : (!empty($satuan2->jml) ? $satuan2->jml : '0')) ?></td>
